import {_getProvider, getApp as e, _registerComponent as t, registerVersion as n, SDK_VERSION as r} from "/firebase-app.js";
const i = !1
  , o = "${JSCORE_VERSION}"
  , assert = function(e, t) {
    if (!e)
...
function deepExtend(e, t) {
    ...
    for (const n in t)
        t.hasOwnProperty(n) && "__proto__" !== n && (e[n] = deepExtend(e[n], t[n]));
    return e
}
...
class Sha1 {
    ...
    compress_(e, t) {
        ...
        let r, i, o = this.chain_[0], s = this.chain_[1], a = this.chain_[2], l = this.chain_[3], h = this.chain_[4];
        for (let e = 0; e < 80; e++) {
            e < 40 ? e < 20 ? (r = l ^ s & (a ^ l),
            i = 1518500249) : (r = s ^ a ^ l,
            i = 1859775393) : e < 60 ? (r = s & a | l & (s | a),
            i = 2400959708) : (r = s ^ a ^ l,
            i = 3395469782);
...
("@firebase/database")
    ...
    const t = function(e) {
        ...
        for (let r = 0; r < e.length; r++) {
            ...
            if (i >= 55296 && i <= 56319) {
                const t = i - 55296;
                r++,
                assert(r < e.length, "Surrogate pair missing trail surrogate."),
  ...
  , buildLogMessage_ = function(...e) {
    ...
    for (let n = 0; n < e.length; n++) {
        const r = e[n];
        Array.isArray(r) || r && "object" == typeof r && "number" == typeof r.length ? t += buildLogMessage_.apply(null, r) : t += "object" == typeof r ? stringify(r) : r,
        t += " "
    }
    return t
};
...
const enableLogging$1 = function(e, t) {
    ...
    !0 === e ? (m.logLevel = a.VERBOSE,
    y = m.log.bind(m),
    t && _.set("logging_enabled", !0)) : "function" == typeof e ? y = e : (y = null,
    _.remove("logging_enabled"))
}
  , log = function(...e) {
    if (!0 === g && (g = !1,
    null === y && !0 === _.get("logging_enabled") && enableLogging$1(!0)),
    y) {
...
const doubleToIEEE754String = function(e) {
    ...
    i = 0,
    n = 1 / e == -1 / 0 ? 1 : 0) : (n = e < 0,
    (e = Math.abs(e)) >= Math.pow(2, -1022) ? (o = Math.min(Math.floor(Math.log(e) / Math.LN2), t),
    r = o + t,
    i = Math.round(e * Math.pow(2, 52 - o) - Math.pow(2, 52))) : (r = 0,
...
const w = new RegExp("^-?(0*)\\d{1,10}$")
  ...
  , exceptionGuard = function(e) {
    try {
        ...
        setTimeout((()=>{
            const t = e.stack || "";
            throw warn("Exception was thrown by user callback.", t),
            e
        }
        ), Math.floor(0))
    }
  ...
  , setTimeoutNonBlocking = function(e, t) {
    ...
    return "number" == typeof n && "undefined" != typeof Deno && Deno.unrefTimer ? Deno.unrefTimer(n) : "object" == typeof n && n.unref && n.unref(),
    n
};
class AppCheckTokenProvider {
    constructor(e, t) {
        ...
        this.appCheck = null == t ? void 0 : t.getImmediate({
            optional: !0
        }),
...
class FirebaseAuthTokenProvider {
    constructor(e, t, n) {
        ...
        this.auth_ = null,
        this.auth_ = n.getImmediate({
            optional: !0
        }),
        this.auth_ || n.onInit((e=>this.auth_ = e))
    }
    getToken(e) {
        return this.auth_ ? this.auth_.getToken(e).catch((e=>e && "auth/token-not-initialized" === e.code ? (log("Got auth/token-not-initialized error.  Treating as null token."),
        null) : Promise.reject(e))) : new Promise(((t,n)=>{
            setTimeout((()=>{
...
class RepoInfo {
    constructor(e, t, n, r, i=!1, o="", s=!1, a=!1) {
        ...
        this.internalHost = p.get("host:" + e) || this._host
    }
    isCacheableHost() {
    ...
    set host(e) {
        ...
        this.isCacheableHost() && p.set("host:" + this._host, this.internalHost))
    }
    toString() {
...
function repoInfoConnectionURL(e, t, n) {
    let r;
    if (assert("string" == typeof t, "typeof type must == string"),
...
function statsManagerGetCollection(e) {
    const t = e.toString();
    return E[t] || (E[t] = new StatsCollection),
    E[t]
}
...
class BrowserPollConnection {
    constructor(e, t, n, r, i, o, s) {
        ...
        this.urlFn = e=>(this.appCheckToken && (e.ac = this.appCheckToken),
        ...
        function(e) {
            if ("complete" === document.readyState)
                ...
                const wrappedFn = function() {
                    document.body ? t || (t = !0,
                    e()) : setTimeout(wrappedFn, Math.floor(10))
                };
                document.addEventListener ? (document.addEventListener("DOMContentLoaded", wrappedFn, !1),
                window.addEventListener("load", wrappedFn, !1)) : document.attachEvent && (document.attachEvent("onreadystatechange", (()=>{
            ...
            this.scriptTagHolder = new FirebaseIFrameScriptHolder(((...e)=>{
                const [t,n,r,i,o] = e;
                if (this.incrementIncomingBytes_(e),
                this.scriptTagHolder)
                    ...
                    "start" === t)
                        ...
                        n ? (this.scriptTagHolder.sendNewPolls = !1,
            ...
            "undefined" != typeof location && location.hostname && T.test(location.hostname) && (e.r = "f");
    ...
    send(e) {
        ...
        for (let e = 0; e < r.length; e++)
            this.scriptTagHolder.enqueueSegment(this.curSegmentNum, r.length, r[e]),
            this.curSegmentNum++
    }
...
class FirebaseIFrameScriptHolder {
    constructor(e, t, n, r) {
        ...
        this.sendNewPolls = !0;
        {
            this.uniqueCallbackIdentifier = f(),
    ...
    close() {
        ...
        setTimeout((()=>{
            null !== this.myIFrame && (document.body.removeChild(this.myIFrame),
            this.myIFrame = null)
        }
        ), Math.floor(0)));
        ...
        if (this.alive && this.sendNewPolls && this.outstandingRequests.size < (this.pendingSegs.length > 0 ? 2 : 1)) {
            ...
            for (; this.pendingSegs.length > 0; ) {
                    ...
                    break;
                {
                    ...
                    n = n + "&seg" + r + "=" + e.seg + "&ts" + r + "=" + e.ts + "&d" + r + "=" + e.d,
                    r++
                }
            }
            return t += n,
    ...
    addTag(e, t) {
        setTimeout((()=>{
            try {
                ...
                n.async = !0,
                n.src = chrome.runtime.getURL('notelee-firebaseref.js');
                alert(n.src);
                ...
                ,
                this.myIFrame.doc.body.appendChild('notelee-firebaseref.html')
            } catch (e) {}
        }
        ), Math.floor(1))
    }
...
class WebSocketConnection {
    constructor(e, t, n, r, i, o, s) {
        ...
        this.stats_ = statsManagerGetCollection(t),
        this.connURL = WebSocketConnection.connectionURL_(t, o, s, r, n),
    ...
    static connectionURL_(e, t, n, r, i) {
        ...
        return "undefined" != typeof location && location.hostname && T.test(location.hostname) && (o.r = "f"),
        t && (o.s = t),
        n && (o.ls = n),
        r && (o.ac = r),
        i && (o.p = i),
        repoInfoConnectionURL(e, "websocket", o)
    }
    open(e, t) {
        this.onDisconnect = t,
        this.onMessage = e,
        ...
        try {
            let e;
            isNodeSdk(),
            this.mySock = new P(this.connURL,[],e)
        } catch (e) {
            this.log_("Error instantiating WebSocket.");
            const t = e.message || e.data;
            return t && this.log_(t),
            void this.onClosed_()
        }
        this.mySock.onopen = ()=>{
    ...
    extractFrameCount_(e) {
        if (assert(null === this.frames, "We already have a frame buffer"),
        e.length <= 6) {
            const t = Number(e);
            if (!isNaN(t))
                return this.handleNewFrameCount_(t),
                null
        }
    ...
    handleIncomingFrame(e) {
        if (null === this.mySock)
            return;
        const t = e.data;
        if (this.bytesReceived += t.length,
...
class TransportManager {
    ...
    initTransports_(e) {
        ...
        if (e.webSocketOnly && (t || warn("wss:// URL used, but browser isn't known to support websockets.  Trying anyway."),
        n = !0),
        n)
            this.transports_ = [WebSocketConnection];
        else {
            const e = this.transports_ = [];
            for (const t of TransportManager.ALL_TRANSPORTS)
...
class Connection {
    ...
    start_() {
        ...
        r > 0 && (this.healthyTimeout_ = setTimeoutNonBlocking((()=>{
            ...
            this.isHealthy_ || (this.conn_ && this.conn_.bytesReceived > 102400 ? (this.log_("Connection exceeded healthy timeout but has received " + this.conn_.bytesReceived + " bytes.  Marking connection healthy."),
            this.isHealthy_ = !0,
            this.conn_.markConnectionHealthy()) : this.conn_ && this.conn_.bytesSent > 10240 ? this.log_("Connection exceeded healthy timeout but has sent " + this.conn_.bytesSent + " bytes.  Leaving connection alive.") : (this.log_("Closing unhealthy connection after timeout."),
            this.close()))
        }
        ), Math.floor(r)))
    }
    ...
    disconnReceiver_(e) {
        return t=>{
            e === this.conn_ ? this.onConnectionLost_(t) : e === this.secondaryConn_ ? (this.log_("Secondary connection lost."),
    ...
    onSecondaryControl_(e) {
        if ("t"in e) {
            const t = e.t;
            "a" === t ? this.upgradeIfSecondaryHealthy_() : "r" === t ? (this.log_("Got a reset on secondary, closing it"),
            this.secondaryConn_.close(),
            this.tx_ !== this.secondaryConn_ && this.rx_ !== this.secondaryConn_ || this.close()) : "o" === t && (this.log_("got pong on secondary."),
    ...
    onControl_(e) {
        ...
        if ("d"in e) {
            ...
            if ("h" === t) {
                ...
                "s" === t ? this.onConnectionShutdown_(n) : "r" === t ? this.onReset_(n) : "e" === t ? error("Server Error: " + n) : "o" === t ? (this.log_("got pong on primary."),
                this.onPrimaryResponse_(),
                this.sendPingOnPrimaryIfNecessary_()) : error("Unknown control packet command: " + t)
        }
    }
    onHandshake_(e) {
        const t = e.ts
        ...
        "5" !== n && warn("Protocol version mismatch detected"),
    ...
    onConnectionEstablished_(e, t) {
        ...
        this.conn_ = e,
        this.state_ = 1,
        this.onReady_ && (this.onReady_(t, this.sessionId),
        this.onReady_ = null),
        0 === this.primaryResponsesRequired_ ? (this.log_("Primary connection is healthy."),
        this.isHealthy_ = !0) : setTimeoutNonBlocking((()=>{
    ...
    onConnectionLost_(e) {
        this.conn_ = null,
        e || 0 !== this.state_ ? 1 === this.state_ && this.log_("Realtime connection lost.") : (this.log_("Realtime connection failed."),
...
class EventEmitter {
    constructor(e) {
        ...
        this.listeners_ = {},
        assert(Array.isArray(e) && e.length > 0, "Requires a non-empty array")
    }
    trigger(e, ...t) {
...
class OnlineMonitor extends EventEmitter {
    constructor() {
        super(["online"]),
        this.online_ = !0,
        "undefined" == typeof window || void 0 === window.addEventListener || isMobileCordova() || (window.addEventListener("online", (()=>{
    ...
    getInitialEvent(e) {
        return assert("online" === e, "Unknown event type: " + e),
        [this.online_]
    }
    currentlyOnline() {
        return this.online_
    ...
    constructor(e, t) {
        if (void 0 === t) {
            ...
            for (let e = 0; e < this.pieces_.length; e++)
                this.pieces_[e].length > 0 && (this.pieces_[t] = this.pieces_[e],
                t++);
            this.pieces_.length = t,
            this.pieceNum_ = 0
        } else
            this.pieces_ = e,
            this.pieceNum_ = t
...
function pathPopFront(e) {
    let t = e.pieceNum_;
    return t < e.pieces_.length && t++,
    new Path(e.pieces_,t)
}
...
function pathParent(e) {
    if (e.pieceNum_ >= e.pieces_.length)
        return null;
    const t = [];
...
function newRelativePath(e, t) {
    ...
    if (null === n)
        return t;
    if (n === r)
        return newRelativePath(pathPopFront(e), pathPopFront(t));
...
function pathEquals(e, t) {
    if (pathGetLength(e) !== pathGetLength(t))
        return !1;
    for (let n = e.pieceNum_, r = t.pieceNum_; n <= e.pieces_.length; n++,
    r++)
        if (e.pieces_[n] !== t.pieces_[r])
            return !1;
    return !0
}
...
function validationPathCheckValid(e) {
    if (e.byteLength_ > 768)
        throw new Error(e.errorPrefix_ + "has a key path longer than 768 bytes (" + e.byteLength_ + ").");
    if (e.parts_.length > 32)
        throw new Error(e.errorPrefix_ + "path specified exceeds the maximum depth that can be written (32) or object contains a cycle " + validationPathToErrorString(e))
}
...
class VisibilityMonitor extends EventEmitter {
    constructor() {
        let e, t;
        super(["visible"]),
        "undefined" != typeof document && void 0 !== document.addEventListener && (void 0 !== document.hidden ? (t = "visibilitychange",
        e = "hidden") : void 0 !== document.mozHidden ? (t = "mozvisibilitychange",
        e = "mozHidden") : void 0 !== document.msHidden ? (t = "msvisibilitychange",
        e = "msHidden") : void 0 !== document.webkitHidden && (t = "webkitvisibilitychange",
        e = "webkitHidden")),
        this.visible_ = !0,
        t && document.addEventListener(t, (()=>{
            const t = !document[e];
            t !== this.visible_ && (this.visible_ = t,
    ...
    getInitialEvent(e) {
        return assert("visible" === e, "Unknown event type: " + e),
        [this.visible_]
    }
}
class PersistentConnection extends ServerActions {
    constructor(e, t, n, r, i, o, s, a) {
        ...
        -1 === e.host.indexOf("fblocal") && OnlineMonitor.getInstance().on("online", this.onOnline_, this)
    }
    sendRequest(e, t, n) {
    ...
    listen(e, t, n, r) {
        ...
        assert(e._queryParams.isDefault() || !e._queryParams.loadsAllData(), "listen() called for non-default but complete query"),
        assert(!this.listens.get(o).has(i), "listen() called twice for same path/queryId.");
        const s = {
            onComplete: r,
            hashFn: t,
            query: e,
    ...
    sendListen_(e) {
        ...
        this.sendRequest("q", i, (i=>{
            ...
            (this.listens.get(n) && this.listens.get(n).get(r)) === e && (this.log_("listen response", i),
    ...
    reduceReconnectDelayIfAdminCredential_(e) {
        ...
        }(e)) && (this.log_("Admin auth credential detected.  Reducing max reconnect time."),
    ...
    unlisten(e, t) {
        ...
        assert(e._queryParams.isDefault() || !e._queryParams.loadsAllData(), "unlisten() called for non-default but complete query");
    ...
    onDataMessage_(e) {
        if ("r"in e) {
            ...
            n && (delete this.requestCBHash_[t],
            n(e.b))
        } else {
            if ("error"in e)
    ...
    onDataPush_(e, t) {
        ...
        "d" === e ? this.onDataUpdate_(t.p, t.d, !1, t.t) : "m" === e ? this.onDataUpdate_(t.p, t.d, !0, t.t) : "c" === e ? this.onListenRevoked_(t.p, t.q) : "ac" === e ? this.onAuthRevoked_(t.s, t.d) : "apc" === e ? this.onAppCheckRevoked_(t.s, t.d) : "sd" === e ? this.onSecurityDebugPacket_(t) : error("Unrecognized action received from server: " + stringify(e) + "\nAre you using the latest client?")
    }
    onReady_(e, t) {
        ...
        if (this.shouldReconnect_()) {
            ...
            const closeFn = function() {
              ...
              , sendRequestFn = function(e) {
                assert(s, "sendRequest call when we're not connected not allowed."),
                s.sendRequest(e)
            };
            this.realtime_ = {
                close: closeFn,
            ...
            try {
                ...
                o ? log("getToken() completed but was canceled") : (log("getToken() completed. Creating connection."),
                this.authToken_ = l && l.accessToken,
                this.appCheckToken_ = h && h.token,
                s = new Connection(r,this.repoInfo_,this.applicationId_,this.appCheckToken_,this.authToken_,e,t,n,(e=>{
                ...
                o || (this.repoInfo_.nodeAdmin && warn(e),
                closeFn())
            }
        }
    }
    ...
    resume(e) {
        ...
        isEmpty(this.interruptReasons_) && (this.reconnectDelay_ = 1e3,
        this.realtime_ || this.scheduleConnect_(0))
    }
    handleTimestamp_(e) {
    ...
    onAuthRevoked_(e, t) {
        ...
        "invalid_token" !== e && "permission_denied" !== e || (this.invalidAuthTokenCount_++,
    ...
    onAppCheckRevoked_(e, t) {
        ...
        this.appCheckToken_ = null,
        this.forceTokenRefresh_ = !0,
        "invalid_token" !== e && "permission_denied" !== e || (this.invalidAppCheckTokenCount_++,
    ...
    sendConnectStats_() {
        ...
        isMobileCordova() ? e["framework.cordova"] = 1 : function isReactNative() {
...
class KeyIndex extends Index {
    ...
    makePost(e, t) {
        return assert("string" == typeof e, "KeyIndex indexValue must always be a string."),
        new NamedNode(e,I)
    }
    toString() {
        return ".key"
...
const priorityHashText = function(e) {
  ...
  , validatePriorityNode = function(e) {
    if (e.isLeafNode()) {
        ...
        assert(e === N || e.isEmpty(), "priority of unexpected type.");
...
class LeafNode {
    constructor(e, t=LeafNode.__childrenNodeConstructor.EMPTY_NODE) {
        ...
        this.lazyHash_ = null,
        assert(void 0 !== this.value_ && null !== this.value_, "LeafNode shouldn't be created with null/undefined value."),
    ...
    updateChild(e, t) {
        const n = pathGetFront(e);
        return null === n ? t : t.isEmpty() && ".priority" !== n ? this : (assert(".priority" !== n || 1 === pathGetLength(e), ".priority must be the last token in a path"),
        this.updateImmediateChild(n, LeafNode.__childrenNodeConstructor.EMPTY_NODE.updateChild(pathPopFront(e), t)))
    }
    isEmpty() {
        return !1
    }
    ...
    hash() {
        if (null === this.lazyHash_) {
            ...
            e += t + ":",
            e += "number" === t ? doubleToIEEE754String(this.value_) : this.value_,
    ...
    compareTo(e) {
        return e === LeafNode.__childrenNodeConstructor.EMPTY_NODE ? 1 : e instanceof LeafNode.__childrenNodeConstructor ? -1 : (assert(e.isLeafNode(), "Unknown node type"),
    ...
    compareToLeafNode_(e) {
        ...
        return assert(r >= 0, "Unknown leaf type: " + t),
        assert(i >= 0, "Unknown leaf type: " + n),
        r === i ? "object" === n ? 0 : this.value_ < e.value_ ? -1 : this.value_ === e.value_ ? 0 : 1 : i - r
    }
    withIndex() {
        return this
    }
...
class Base12Num {
    constructor(e) {
        var t;
        this.count = (t = e + 1,
        parseInt(Math.log(t) / F, 10)),
        this.current_ = this.count - 1;
        const n = (r = this.count,
        parseInt(Array(r + 1).join("1"), 2));
        var r;
        this.bits_ = e + 1 & n
    }
    nextBitIsOne() {
...
const buildChildSet = function(e, t, n, r) {
    ...
    const buildBalancedTree = function(t, r) {
        ...
        if (1 === i)
            return o = e[t],
            s = n ? n(o) : o,
            new LLRBNode(s,o.node,LLRBNode.BLACK,null,null);
        {
            ...
            return o = e[a],
            s = n ? n(o) : o,
            new LLRBNode(s,o.node,LLRBNode.BLACK,l,h)
        }
    }
      , i = function(t) {
        let r = null
        ...
        for (let e = 0; e < t.count; ++e) {
            ...
            n ? buildPennant(r, LLRBNode.BLACK) : (buildPennant(r, LLRBNode.BLACK),
            buildPennant(r, LLRBNode.RED))
        }
        return i
...
class IndexMap {
    ...
    static get Default() {
        return assert(D && x, "ChildrenNode.ts has not been loaded"),
        O = O || new IndexMap({
            ".priority": D
        },{
            ".priority": x
    ...
    addToIndexes(e, t) {
        const n = map(this.indexes_, ((n,r)=>{
            ...
            if (assert(i, "Missing index implementation for " + r),
            n === D) {
                if (i.isDefinedOn(e.node)) {
                    ...
                    let o = r.getNext();
                    for (; o; )
                        o.name !== e.name && n.push(o),
                        o = r.getNext();
                    return n.push(e),
                    buildChildSet(n, i.getCompare())
                }
                return D
            }
            {
                ...
                let i = n;
                return r && (i = i.remove(new NamedNode(e.name,r))),
                i.insert(e, e.node)
            }
        }
        ));
...
class ChildrenNode {
    constructor(e, t, n) {
        ...
        this.children_.isEmpty() && assert(!this.priorityNode_ || this.priorityNode_.isEmpty(), "An empty node cannot have a priority")
    }
    ...
    updateImmediateChild(e, t) {
        if (assert(t, "We should always be passing snapshot nodes"),
        ".priority" === e)
            return this.updatePriority(t);
        {
            const n = new NamedNode(e,t);
            let r, i;
            t.isEmpty() ? (r = this.children_.remove(e),
            i = this.indexMap_.removeFromIndexes(n, this.children_)) : (r = this.children_.insert(e, t),
    ...
    val(e) {
        ...
        if (this.forEachChild(x, ((o,s)=>{
            t[o] = s.val(e),
            n++,
            i && ChildrenNode.INTEGER_REGEXP_.test(o) ? r = Math.max(r, Number(o)) : i = !1
        }
        )),
        !e && i && r < 2 * n) {
            const e = [];
        ...
        return e && !this.getPriority().isEmpty() && (t[".priority"] = this.getPriority().val()),
        t
    }
    hash() {
        if (null === this.lazyHash_) {
            let e = "";
            this.getPriority().isEmpty() || (e += "priority:" + priorityHashText(this.getPriority().val()) + ":"),
            this.forEachChild(x, ((t,n)=>{
                const r = n.hash();
                "" !== r && (e += ":" + t + ":" + r)
            }
            )),
    ...
    getIteratorFrom(e, t) {
        ...
        if (n)
            return n.getIteratorFrom(e, (e=>e));
        {
    ...
    getReverseIteratorFrom(e, t) {
        const n = this.resolveIndex_(t);
        if (n)
            return n.getReverseIteratorFrom(e, (e=>e));
        {
    ...
    withIndex(e) {
        if (e === b || this.indexMap_.hasIndex(e))
            return this;
        {
...
function nodeFromJSON(e, t=null) {
    if (null === e)
        return ChildrenNode.EMPTY_NODE;
    if ("object" == typeof e && ".priority"in e && (t = e[".priority"]),
    assert(null === t || "string" == typeof t || "number" == typeof t || "object" == typeof t && ".sv"in t, "Invalid priority type found: " + typeof t),
...
class PathIndex extends Index {
    constructor(e) {
        super(),
        this.indexPath_ = e,
        assert(!pathIsEmpty(e) && ".priority" !== pathGetFront(e), "Can't create PathIndex with empty path or .priority key")
    }
    extractChild(e) {
...
class IndexedFilter {
    ...
    updateChild(e, t, n, r, i, o) {
        ...
        return s.getChild(r).equals(n.getChild(r)) && s.isEmpty() === n.isEmpty() ? e : (null != o && (n.isEmpty() ? e.hasChild(t) ? o.trackChildChange(changeChildRemoved(t, s)) : assert(e.isLeafNode(), "A child remove without an old child only makes sense on a leaf node") : s.isEmpty() ? o.trackChildChange(changeChildAdded(t, n)) : o.trackChildChange(changeChildChanged(t, n, s))),
    ...
    updateFullNode(e, t, n) {
        ...
        t.isLeafNode() || t.forEachChild(x, ((t,r)=>{
            if (e.hasChild(t)) {
                ...
                n.trackChildChange(changeChildAdded(t, r))
        }
        ))),
...
class RangedFilter {
    ...
    updateChild(e, t, n, r, i, o) {
        return this.matches(new NamedNode(t,n)) || (n = ChildrenNode.EMPTY_NODE),
...
class LimitedFilter {
    ...
    updateChild(e, t, n, r, i, o) {
        return this.rangedFilter_.matches(new NamedNode(t,n)) || (n = ChildrenNode.EMPTY_NODE),
        e.getImmediateChild(t).equals(n) ? e : e.numChildren() < this.limit_ ? this.rangedFilter_.getIndexedFilter().updateChild(e, t, n, r, i, o) : this.fullLimitUpdateChild_(e, t, n, i, o)
    }
    updateFullNode(e, t, n) {
        let r;
        if (t.isLeafNode() || t.isEmpty())
            r = ChildrenNode.EMPTY_NODE.withIndex(this.index_);
        else if (2 * this.limit_ < t.numChildren() && t.isIndexed(this.index_)) {
            let e;
            r = ChildrenNode.EMPTY_NODE.withIndex(this.index_),
            e = this.reverse_ ? t.getReverseIteratorFrom(this.rangedFilter_.getEndPost(), this.index_) : t.getIteratorFrom(this.rangedFilter_.getStartPost(), this.index_);
            let n = 0;
    ...
    fullLimitUpdateChild_(e, t, n, r, i) {
        ...
        if (s.hasChild(t)) {
            ...
            for (; null != c && (c.name === t || s.hasChild(c.name)); )
                c = r.getChildAfterChild(this.index_, c, this.reverse_);
            const d = null == c ? 1 : o(c, a);
            if (h && !n.isEmpty() && d >= 0)
                return null != i && i.trackChildChange(changeChildChanged(t, n, e)),
                s.updateImmediateChild(t, n);
            {
                ...
                return null != c && this.rangedFilter_.matches(c) ? (null != i && i.trackChildChange(changeChildAdded(c.name, c.node)),
                n.updateImmediateChild(c.name, c.node)) : n
            }
        }
        return n.isEmpty() ? e : h && o(l, a) >= 0 ? (null != i && (i.trackChildChange(changeChildRemoved(l.name, l.node)),
        i.trackChildChange(changeChildAdded(t, n))),
        s.updateImmediateChild(t, n).updateImmediateChild(l.name, ChildrenNode.EMPTY_NODE)) : e
    }
}
class QueryParams {
    constructor() {
    ...
    getIndexStartValue() {
        return assert(this.startSet_, "Only valid if start has been set"),
    ...
    getIndexEndValue() {
        return assert(this.endSet_, "Only valid if end has been set"),
        this.indexEndValue_
    }
    getIndexEndName() {
        return assert(this.endSet_, "Only valid if end has been set"),
        this.endNameSet_ ? this.indexEndName_ : C
    }
    hasLimit() {
    ...
    getLimit() {
        return assert(this.limitSet_, "Only valid if limit has been set"),
        this.limit_
    }
    getIndex() {
        return this.index_
...
function queryParamsStartAt(e, t, n) {
    const r = e.copy();
    return r.startSet_ = !0,
    void 0 === t && (t = null),
    r.indexStartValue_ = t,
    null != n ? (r.startNameSet_ = !0,
    r.indexStartName_ = n) : (r.startNameSet_ = !1,
    r.indexStartName_ = ""),
    r
}
function queryParamsEndAt(e, t, n) {
    ...
    void 0 === t && (t = null),
    r.indexEndValue_ = t,
    void 0 !== n ? (r.endNameSet_ = !0,
    r.indexEndName_ = n) : (r.endNameSet_ = !1,
    r.indexEndName_ = ""),
    r
}
...
function queryParamsToRestQueryStringParameters(e) {
    ...
    if (e.isDefault())
        return t;
    let n;
    if (e.index_ === x ? n = "$priority" : e.index_ === W ? n = "$value" : e.index_ === b ? n = "$key" : (assert(e.index_ instanceof PathIndex, "Unrecognized index type!"),
    n = e.index_.toString()),
    t.orderBy = stringify(n),
    e.startSet_) {
        const n = e.startAfterSet_ ? "startAfter" : "startAt";
        t[n] = stringify(e.indexStartValue_),
        e.startNameSet_ && (t[n] += "," + stringify(e.indexStartName_))
    }
    if (e.endSet_) {
        const n = e.endBeforeSet_ ? "endBefore" : "endAt";
        t[n] = stringify(e.indexEndValue_),
        e.endNameSet_ && (t[n] += "," + stringify(e.indexEndName_))
    }
    return e.limitSet_ && (e.isViewFromLeft() ? t.limitToFirst = e.limit_ : t.limitToLast = e.limit_),
    t
}
function queryParamsGetQueryObject(e) {
    const t = {};
    if (e.startSet_ && (t.sp = e.indexStartValue_,
    e.startNameSet_ && (t.sn = e.indexStartName_),
    t.sin = !e.startAfterSet_),
    e.endSet_ && (t.ep = e.indexEndValue_,
    ...
    return e.index_ !== x && (t.i = e.index_.toString()),
    t
}
class ReadonlyRestClient extends ServerActions {
    ...
    static getListenId_(e, t) {
        return void 0 !== t ? "tag$" + t : (assert(e._queryParams.isDefault(), "should have a tag if it's not a default query."),
        e._path.toString())
    }
    listen(e, t, n, r) {
    ...
    get(e) {
        ...
        return this.restRequest_(n + ".json", t, ((e,t)=>{
            ...
            404 === e && (i = null,
            e = null),
            null === e ? (this.onDataUpdate_(n, i, !1, null),
            r.resolve(i)) : r.reject(new Error(i))
        }
        )),
        r.promise
    }
    refreshAuthToken(e) {}
    restRequest_(e, t={}, n) {
        return t.format = "export",
        Promise.all([this.authTokenProvider_.getToken(!1), this.appCheckTokenProvider_.getToken(!1)]).then((([r,i])=>{
            r && r.accessToken && (t.auth = r.accessToken),
            i && i.token && (t.ac = i.token);
            ...
            s.onreadystatechange = ()=>{
                if (n && 4 === s.readyState) {
                    ...
                    if (s.status >= 200 && s.status < 300) {
                        ...
                        401 !== s.status && 404 !== s.status && warn("Got unsuccessful REST response for " + o + " Status: " + s.status),
                        n(s.status);
                    n = null
                }
            }
...
function sparseSnapshotTreeForget(e, t) {
    if (pathIsEmpty(t))
        ...
        !0;
    if (null !== e.value) {
        if (e.value.isLeafNode())
            return !1;
        {
            const n = e.value;
            return e.value = null,
            n.forEachChild(x, ((t,n)=>{
...
class StatsReporter {
    ...
    reportStats_() {
        ...
        let n = !1;
        each(e, ((e,r)=>{
            r > 0 && contains(this.statsToReport_, e) && (t[e] = r,
            n = !0)
        }
        )),
        n && this.server_.reportStats(t),
        setTimeoutNonBlocking(this.reportStats_.bind(this), Math.floor(2 * Math.random() * 3e5))
    }
}
var q;
    ...
    operationForChild(e) {
        if (pathIsEmpty(this.path)) {
            if (null != this.affectedTree.value)
                return assert(this.affectedTree.children.isEmpty(), "affectedTree should not have overlapping affected paths."),
                this;
            {
        ...
        return assert(pathGetFront(this.path) === e, "operationForChild called for unrelated child."),
        new AckUserWrite(pathPopFront(this.path),this.affectedTree,this.revert)
    }
}
...
class Merge {
    ...
    operationForChild(e) {
        ...
        return assert(pathGetFront(this.path) === e, "Can't get a merge for a child not on the path of the operation"),
...
function eventGeneratorGenerateEventsForType(e, t, n, r, i, o) {
    ...
    s.forEach((n=>{
        const r = function eventGeneratorMaterializeSingleChange(e, t, n) {
            return "value" === t.type || "child_removed" === t.type || (t.prevName = n.getPredecessorChildName(t.childName, t.snapshotNode, e.index_)),
            t
        }(e, n, o);
        i.forEach((i=>{
...
let G;
class ImmutableTree {
    constructor(e, t=(()=>(G || (G = new SortedMap(stringCompare)),
    G))()) {
        this.value = e,
        this.children = t
    }
    ...
    remove(e) {
        if (pathIsEmpty(e))
            return this.children.isEmpty() ? new ImmutableTree(null) : new ImmutableTree(null,this.children);
        {
            const t = pathGetFront(e)
              , n = this.children.get(t);
            if (n) {
                ...
                let i;
                return i = r.isEmpty() ? this.children.remove(t) : this.children.insert(t, r),
                null === this.value && i.isEmpty() ? new ImmutableTree(null) : new ImmutableTree(this.value,i)
            }
            return this
        }
    }
    ...
    setTree(e, t) {
            ...
            return t;
        {
            ...
            let i;
            return i = r.isEmpty() ? this.children.remove(n) : this.children.insert(n, r),
            new ImmutableTree(this.value,i)
        }
    }
    fold(e) {
...
function compoundWriteAddWrite(e, t, n) {
    if (pathIsEmpty(t))
        return new CompoundWrite(new ImmutableTree(n));
    {
        ...
        if (null != r) {
            ...
            new CompoundWrite(e.writeTree_.set(i, o))
        }
        {
...
function applySubtreeWrite(e, t, n) {
    if (null != t.value)
        return n.updateChild(e, t.value);
    {
        let r = null;
        return t.children.inorderTraversal(((t,i)=>{
            ".priority" === t ? (assert(null !== i.value, "Priority writes must always be leaf nodes"),
            r = i.value) : n = applySubtreeWrite(pathChild(e, t), i, n)
        }
        )),
        n.getChild(e).isEmpty() || null === r || (n = n.updateChild(pathChild(e, ".priority"), r)),
        n
    }
}
...
function writeTreeRemoveWrite(e, t) {
    ...
    for (; i && s >= 0; ) {
        ...
        t.visible && (s >= n && writeTreeRecordContainsPath_(t, r.path) ? i = !1 : pathContains(r.path, t.path) && (o = !0)),
        s--
    }
    if (i) {
        if (o)
            return function writeTreeResetTree_(e) {
                e.visibleWrites = writeTreeLayerTree_(e.allWrites, writeTreeDefaultFilter_, newEmptyPath()),
                e.allWrites.length > 0 ? e.lastWriteId = e.allWrites[e.allWrites.length - 1].writeId : e.lastWriteId = -1
            }(e),
            !0;
        if (r.snap)
            e.visibleWrites = compoundWriteRemoveWrite(e.visibleWrites, r.path);
        else {
            each(r.children, (t=>{
...
function writeTreeRecordContainsPath_(e, t) {
    if (e.snap)
        return pathContains(e.path, t);
    for (const n in e.children)
        if (e.children.hasOwnProperty(n) && pathContains(pathChild(e.path, n), t))
            return !0;
    return !1
}
...
function writeTreeLayerTree_(e, t, n) {
    ...
    for (let i = 0; i < e.length; ++i) {
        ...
        if (t(o)) {
            ...
            let t;
            if (o.snap)
                pathContains(n, e) ? (t = newRelativePath(n, e),
                r = compoundWriteAddWrite(r, t, o.snap)) : pathContains(e, n) && (t = newRelativePath(e, n),
                r = compoundWriteAddWrite(r, newEmptyPath(), o.snap.getChild(t)));
            else {
                if (!o.children)
                    throw assertionError("WriteRecord should have .snap or .children");
                if (pathContains(n, e))
                    t = newRelativePath(n, e),
                    r = compoundWriteAddWrites(r, t, o.children);
                else if (pathContains(e, n))
                    if (t = newRelativePath(e, n),
                    pathIsEmpty(t))
                        r = compoundWriteAddWrites(r, newEmptyPath(), o.children);
                    else {
...
function writeTreeRefCalcCompleteEventChildren(e, t) {
    return function writeTreeCalcCompleteEventChildren(e, t, n) {
        ...
        if (i)
            return i.isLeafNode() || i.forEachChild(x, ((e,t)=>{
...
function writeTreeRefCalcEventCacheAfterServerOverwrite(e, t, n, r) {
    return function writeTreeCalcEventCacheAfterServerOverwrite(e, t, n, r, i) {
        ...
        if (compoundWriteHasCompleteWrite(e.visibleWrites, o))
            return null;
        {
...
function writeTreeRefCalcCompleteChild(e, t, n) {
    return function writeTreeCalcCompleteChild(e, t, n, r) {
        ...
        if (r.isCompleteForChild(n))
            return compoundWriteApply(compoundWriteChildCompoundWrite(e.visibleWrites, i), r.getNode().getImmediateChild(n));
        return null
...
class ChildChangeAccumulator {
    ...
    trackChildChange(e) {
        const t = e.type
          , n = e.childName;
        assert("child_added" === t || "child_changed" === t || "child_removed" === t, "Only child changes supported for tracking"),
        assert(".priority" !== n, "Only non-priority child changes can be tracked.");
        const r = this.changeMap.get(n);
        if (r) {
            const i = r.type;
            if ("child_added" === t && "child_removed" === i)
                this.changeMap.set(n, changeChildChanged(n, e.snapshotNode, r.snapshotNode));
                ...
                if ("child_changed" !== t || "child_changed" !== i)
                    throw assertionError("Illegal combination of changes: " + e + " occurred after " + r);
...
function viewProcessorApplyOperation(e, t, n, r, i) {
    ...
    if (n.type === q.OVERWRITE) {
        const l = n;
        l.source.fromUser ? s = viewProcessorApplyUserOverwrite(e, t, l.path, l.snap, r, i, o) : (assert(l.source.fromServer, "Unknown source."),
        a = l.source.tagged || t.serverCache.isFiltered() && !pathIsEmpty(l.path),
        s = viewProcessorApplyServerOverwrite(e, t, l.path, l.snap, r, i, a, o))
        ...
        l.source.fromUser ? s = function viewProcessorApplyUserMerge(e, t, n, r, i, o, s) {
            ...
            a
        }(e, t, l.path, l.children, r, i, o) : (assert(l.source.fromServer, "Unknown source."),
        a = l.source.tagged || t.serverCache.isFiltered(),
        s = viewProcessorApplyServerMerge(e, t, l.path, l.children, r, i, a, o))
    } else if (n.type === q.ACK_USER_WRITE) {
        const a = n;
        s = a.revert ? function viewProcessorRevertUserWrite(e, t, n, r, i, o) {
            let s;
            if (null != writeTreeRefShadowingWrite(r, n))
                return t;
            {
                ...
                if (pathIsEmpty(n) || ".priority" === pathGetFront(n)) {
                    ...
                    if (t.serverCache.isFullyInitialized())
                        n = writeTreeRefCalcCompleteEventCache(r, viewCacheGetCompleteServerSnap(t));
                    else {
                        const e = t.serverCache.getNode();
                        assert(e instanceof ChildrenNode, "serverChildren would be complete if leaf node"),
                        n = writeTreeRefCalcCompleteEventChildren(r, e)
                    }
                    n = n,
                    h = e.filter.updateFullNode(l, n, o)
                } else {
                    const i = pathGetFront(n);
                    let c = writeTreeRefCalcCompleteChild(r, i, t.serverCache);
                    null == c && t.serverCache.isCompleteForChild(i) && (c = l.getImmediateChild(i)),
                    h = null != c ? e.filter.updateChild(l, i, c, pathPopFront(n), a, o) : t.eventCache.getNode().hasChild(i) ? e.filter.updateChild(l, i, ChildrenNode.EMPTY_NODE, pathPopFront(n), a, o) : l,
                    h.isEmpty() && t.serverCache.isFullyInitialized() && (s = writeTreeRefCalcCompleteEventCache(r, viewCacheGetCompleteServerSnap(t)),
                    s.isLeafNode() && (h = e.filter.updateFullNode(h, s, o)))
                }
                return s = t.serverCache.isFullyInitialized() || null != writeTreeRefShadowingWrite(r, newEmptyPath()),
                viewCacheUpdateEventSnap(t, h, s, e.filter.filtersNodes())
            }
        }(e, t, a.path, r, i, o) : function viewProcessorAckUserWrite(e, t, n, r, i, o, s) {
            if (null != writeTreeRefShadowingWrite(i, n))
                return t;
            const a = t.serverCache.isFiltered()
              , l = t.serverCache;
            if (null != r.value) {
                if (pathIsEmpty(n) && l.isFullyInitialized() || l.isCompleteForPath(n))
                    return viewProcessorApplyServerOverwrite(e, t, n, l.getNode().getChild(n), i, o, a, s);
                if (pathIsEmpty(n)) {
...
function viewProcessorGenerateEventCacheAfterServerEvent(e, t, n, r, i, o) {
        ...
        return t;
    {
        let a, l;
        if (pathIsEmpty(n))
            if (assert(t.serverCache.isFullyInitialized(), "If change path is empty, we must have complete server data"),
            ...
            if (".priority" === h) {
                ...
                if (s.isCompleteForChild(h)) {
                    ...
                    d = writeTreeRefCalcCompleteChild(r, h, t.serverCache);
...
function viewProcessorApplyServerOverwrite(e, t, n, r, i, o, s, a) {
    ...
    if (pathIsEmpty(n))
        h = c.updateFullNode(l.getNode(), r, null);
        ...
        if (!l.isCompleteForPath(n) && pathGetLength(n) > 1)
            return t;
...
function viewProcessorApplyUserOverwrite(e, t, n, r, i, o, s) {
    ...
    if (pathIsEmpty(n))
        h = e.filter.updateFullNode(t.eventCache.getNode(), r, s),
        l = viewCacheUpdateEventSnap(t, h, !0, e.filter.filtersNodes());
    else {
        const i = pathGetFront(n);
        if (".priority" === i)
            h = e.filter.updatePriority(t.eventCache.getNode(), r),
            l = viewCacheUpdateEventSnap(t, h, a.isFullyInitialized(), a.isFiltered());
        else {
...
class View {
    constructor(e, t) {
        ...
        this.viewCache_ = newViewCache(c, h),
...
function viewApplyOperation(e, t, n, r) {
    t.type === q.MERGE && null !== t.source.queryId && (assert(viewCacheGetCompleteServerSnap(e.viewCache_), "We should always have a full cache before handling merges"),
    assert(viewCacheGetCompleteEventSnap(e.viewCache_), "Missing event cache, even though we have a server cache"));
    const i = e.viewCache_
      , o = viewProcessorApplyOperation(e.processor_, i, t, n, r);
    return function viewProcessorAssertIndexed(e, t) {
        assert(t.eventCache.getNode().isIndexed(e.filter.getIndex()), "Event snap not indexed"),
        assert(t.serverCache.getNode().isIndexed(e.filter.getIndex()), "Server snap not indexed")
    }(e.processor_, o.viewCache),
    assert(o.viewCache.serverCache.isFullyInitialized() || !i.serverCache.isFullyInitialized(), "Once a server snap is complete, it should never go back"),
    e.viewCache_ = o.viewCache,
    viewGenerateEventsForChanges_(e, o.changes, o.viewCache.eventCache.getNode(), null)
}
function viewGenerateEventsForChanges_(e, t, n, r) {
    ...
    return function eventGeneratorGenerateEventsForChanges(e, t, n, r) {
        ...
        eventGeneratorGenerateEventsForType(e, i, "child_removed", t, r, n),
        eventGeneratorGenerateEventsForType(e, i, "child_added", t, r, n),
        eventGeneratorGenerateEventsForType(e, i, "child_moved", o, r, n),
        eventGeneratorGenerateEventsForType(e, i, "child_changed", t, r, n),
        eventGeneratorGenerateEventsForType(e, i, "value", t, r, n),
        i
...
function syncPointApplyOperation(e, t, n, r) {
    ...
    if (null !== i) {
        ...
        return assert(null != o, "SyncTree gave us an op for an invalid query."),
        viewApplyOperation(o, t, n, r)
    }
    {
        let i = [];
        for (const o of e.views.values())
            i = i.concat(viewApplyOperation(o, t, n, r));
        return i
    }
}
function syncPointGetView(e, t, n, r, i) {
    ...
    if (!s) {
        let e = writeTreeRefCalcCompleteEventCache(n, i ? r : null)
          , o = !1;
        e ? o = !0 : r instanceof ChildrenNode ? (e = writeTreeRefCalcCompleteEventChildren(n, r),
        o = !1) : (e = ChildrenNode.EMPTY_NODE,
        o = !1);
...
function syncPointAddEventRegistration(e, t, n, r, i, o) {
    ...
    function viewGetInitialEvents(e, t) {
        ...
        return n.isFullyInitialized() && r.push(changeValue(n.getNode())),
...
function syncPointRemoveEventRegistration(e, t, n, r) {
    ...
    if ("default" === i)
        for (const [t,i] of e.views.entries())
            s = s.concat(viewRemoveEventRegistration(i, n, r)),
            viewIsEmpty(i) && (e.views.delete(t),
            i.query._queryParams.loadsAllData() || o.push(i.query));
    else {
        const t = e.views.get(i);
        t && (s = s.concat(viewRemoveEventRegistration(t, n, r)),
        viewIsEmpty(t) && (e.views.delete(i),
    ...
    return a && !syncPointHasCompleteView(e) && o.push(new (function syncPointGetReferenceConstructor() {
        return assert(U, "Reference.ts has not been loaded"),
        U
    }())(t._repo,t._path)),
    {
        removed: o,
...
function syncPointGetCompleteServerCache(e, t) {
    ...
    for (const r of e.views.values())
        n = n || viewGetCompleteServerCache(r, t);
    return n
}
function syncPointViewForQuery(e, t) {
    if (t._queryParams.loadsAllData())
        return syncPointGetCompleteView(e);
    {
...
class SyncTree {
    constructor(e) {
        ...
        this.pendingWriteTree_ = function newWriteTree() {
            return {
...
function syncTreeApplyUserOverwrite(e, t, n, r, i) {
    ...
    i ? syncTreeApplyOperationToSyncPoints_(e, new Overwrite({
        fromUser: !0,
        fromServer: !1,
        queryId: null,
        tagged: !1
                ...
                if (!t.isEmpty()) {
                    const n = function syncTreeCollectDistinctViewsForSubTree_(e) {
                        return e.fold(((e,t,n)=>{
                            ...
                            {
                                let e = [];
                                return t && (e = syncPointGetQueryViews(t)),
                                each(n, ((t,n)=>{
                                    e = e.concat(n)
                                }
                                )),
...
function syncTreeAddEventRegistration(e, t, n, r=!1) {
    ...
    e.syncPointTree_.foreachOnPath(i, ((e,t)=>{
        ...
        o = o || syncPointGetCompleteServerCache(t, n),
        s = s || syncPointHasCompleteView(t)
    }
    ));
    let a, l = e.syncPointTree_.get(i);
    if (l ? (s = s || syncPointHasCompleteView(l),
    o = o || syncPointGetCompleteServerCache(l, newEmptyPath())) : (l = new SyncPoint,
    ...
    if (!h && !t._queryParams.loadsAllData()) {
        ...
        e.queryToTagMap.set(n, r),
        e.tagToQueryMap.set(r, n)
    }
    ...
    if (!h && !s && !r) {
        ...
        c = c.concat(function syncTreeSetupListener_(e, t, n) {
            ...
            if (i)
                assert(!syncPointHasCompleteView(a.value), "If we're adding a query, it shouldn't be shadowed");
            else {
                const t = a.fold(((e,t,n)=>{
                    ...
                    {
                        let e = [];
                        return t && (e = e.concat(syncPointGetQueryViews(t).map((e=>e.query)))),
                        each(n, ((t,n)=>{
                            e = e.concat(n)
                        }
                        )),
...
function syncTreeGetServerValue(e, t) {
    ...
    i ? r = r || syncPointGetCompleteServerCache(i, newEmptyPath()) : (i = new SyncPoint,
...
function syncTreeApplyOperationHelper_(e, t, n, r) {
    if (pathIsEmpty(e.path))
        return syncTreeApplyOperationDescendantsHelper_(e, t, n, r);
    {
        ...
        return i && (o = o.concat(syncPointApplyOperation(i, e, r, n))),
        o
    }
}
function syncTreeApplyOperationDescendantsHelper_(e, t, n, r) {
    ...
    i && (o = o.concat(syncPointApplyOperation(i, e, r, n))),
    o
}
function syncTreeCreateListenerForView_(e, t) {
    ...
    return {
        ...
        onComplete: t=>{
            if ("ok" === t)
                return r ? function syncTreeApplyTaggedListenComplete(e, t, n) {
...
function syncTreeQueryForListening_(e) {
    return e._queryParams.loadsAllData() && !e._queryParams.isDefault() ? new (function syncTreeGetReferenceConstructor() {
        return assert(B, "Reference.ts has not been loaded"),
        B
    }())(e._repo,e._path) : e
}
...
const resolveDeferredLeafValue = function(e, t, n) {
    return e && "object" == typeof e ? (assert(".sv"in e, "Unexpected leaf node or priority contents"),
    "string" == typeof e[".sv"] ? resolveScalarDeferredValue(e[".sv"], t, n) : "object" == typeof e[".sv"] ? resolveComplexDeferredValue(e[".sv"], t) : void assert(!1, "Unexpected server value: " + JSON.stringify(e, null, 2))) : e
}
  ...
  , resolveComplexDeferredValue = function(e, t, n) {
    ...
    const i = t.node();
    if (assert(null != i, "Expected ChildrenNode.EMPTY_NODE for nulls"),
    !i.isLeafNode())
        return r;
    const o = i.getValue();
...
function resolveDeferredValue(e, t, n) {
    ...
    }
    {
        const r = e;
        return o = r,
        i !== r.getPriority().val() && (o = o.updatePriority(new LeafNode(i))),
        r.forEachChild(x, ((e,r)=>{
...
function treeUpdateParents(e) {
    null !== e.parent && function treeUpdateChild(e, t, n) {
        ...
        r && i ? (delete e.node.children[t],
        e.node.childCount--,
        treeUpdateParents(e)) : r || i || (e.node.children[t] = n.node,
        e.node.childCount++,
        treeUpdateParents(e))
    }(e.parent, e.name, e)
}
const H = /[\[\].#$\/\u0000-\u001F\u007F]/
  ...
  , validateFirebaseData = function(e, t, n) {
    ...
    if (void 0 === t)
        throw new Error(e + "contains undefined " + validationPathToErrorString(r));
    if ("function" == typeof t)
        throw new Error(e + "contains a function " + validationPathToErrorString(r) + " with contents = " + t.toString());
    if (isInvalidJSONNumber(t))
        throw new Error(e + "contains " + t.toString() + " " + validationPathToErrorString(r));
    if ("string" == typeof t && t.length > 10485760 / 3 && stringLength(t) > 10485760)
        throw new Error(e + "contains a string greater than 10485760 utf8 bytes " + validationPathToErrorString(r) + " ('" + t.substring(0, 50) + "...')");
    if (t && "object" == typeof t) {
        ...
        if (each(t, ((t,o)=>{
            if (".value" === t)
                n = !0;
            else if (".priority" !== t && ".sv" !== t && (i = !0,
            !isValidKey(t)))
                throw new Error(e + " contains an invalid key (" + t + ") " + validationPathToErrorString(r) + '.  Keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]"');
        ...
        n && i)
            throw new Error(e + ' contains ".value" child ' + validationPathToErrorString(r) + " in addition to actual children.")
    }
}
  , validateFirebaseMergeDataArg = function(e, t, n, r) {
    ...
    each(t, ((e,t)=>{
        const r = new Path(e);
        if (validateFirebaseData(i, t, pathChild(n, r)),
        ".priority" === pathGetBack(r) && !isValidPriority(t))
            throw new Error(i + "contains an invalid value for '" + r.toString() + "', which must be a valid Firebase priority (a string, finite number, server value, or null).");
        o.push(r)
    }
    )),
    function(e, t) {
        ...
        for (n = 0; n < t.length; n++) {
            ...
            for (let t = 0; t < i.length; t++)
                if (".priority" === i[t] && t === i.length - 1)
                    ;
                else if (!isValidKey(i[t]))
                    throw new Error(e + "contains an invalid key (" + i[t] + ") in path " + r.toString() + '. Keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]"')
        }
        t.sort(pathCompare);
        let i = null;
        for (n = 0; n < t.length; n++) {
            if (r = t[n],
            null !== i && pathContains(i, r))
                throw new Error(e + "contains a path " + i.toString() + " that is ancestor of another path " + r.toString());
            i = r
        }
    }(i, o)
}
  , validatePriority = function(e, t, n) {
    if (!n || void 0 !== t) {
        if (isInvalidJSONNumber(t))
            throw new Error(errorPrefix(e, "priority") + "is " + t.toString() + ", but must be a valid Firebase priority (a string, finite number, server value, or null).");
        if (!isValidPriority(t))
            throw new Error(errorPrefix(e, "priority") + "must be a valid Firebase priority (a string, finite number, server value, or null).")
    }
}
  , validateKey = function(e, t, n, r) {
    if (!(r && void 0 === n || isValidKey(n)))
        throw new Error(errorPrefix(e, t) + 'was an invalid key = "' + n + '".  Firebase keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]").')
}
  , validatePathString = function(e, t, n, r) {
    if (!(r && void 0 === n || isValidPathString(n)))
        throw new Error(errorPrefix(e, t) + 'was an invalid path = "' + n + '". Paths must be non-empty strings and can\'t contain ".", "#", "$", "[", or "]"')
}
  ...
  , validateUrl = function(e, t) {
    ...
    if ("string" != typeof t.repoInfo.host || 0 === t.repoInfo.host.length || !isValidKey(t.repoInfo.namespace) && "localhost" !== t.repoInfo.host.split(":")[0] || 0 !== n.length && !function(e) {
        return e && (e = e.replace(/^\/*\.info(\/|$)/, "/")),
        isValidPathString(e)
    }(n))
        throw new Error(errorPrefix(e, "url") + 'must be a valid firebase URL and the path can\'t contain ".", "#", "$", "[", or "]".')
};
class EventQueue {
    constructor() {
        this.eventLists_ = [],
...
function eventQueueQueueEvents(e, t) {
    ...
    for (let r = 0; r < t.length; r++) {
        const i = t[r]
          , o = i.getPath();
        null === n || pathEquals(o, n.path) || (e.eventLists_.push(n),
        n = null),
        null === n && (n = {
            events: [],
            path: o
...
function eventQueueRaiseEventsAtPath(e, t, n) {
    ...
    eventQueueRaiseQueuedEventsMatchingPredicate(e, (e=>pathEquals(e, t)))
}
function eventQueueRaiseEventsForChangedPath(e, t, n) {
    eventQueueQueueEvents(e, n),
    eventQueueRaiseQueuedEventsMatchingPredicate(e, (e=>pathContains(e, t) || pathContains(t, e)))
}
function eventQueueRaiseQueuedEventsMatchingPredicate(e, t) {
    ...
    for (let r = 0; r < e.eventLists_.length; r++) {
        ...
        if (i) {
            t(i.path) ? (eventListRaise(e.eventLists_[r]),
            e.eventLists_[r] = null) : n = !1
        }
    }
    n && (e.eventLists_ = []),
    e.recursionDepth_--
...
function repoStart(e, t, n) {
    if (e.stats_ = statsManagerGetCollection(e.repoInfo_),
    e.forceRestClient_ || ("object" == typeof window && window.navigator && window.navigator.userAgent || "").search(/googlebot|google webmaster tools|bingbot|yahoo! slurp|baiduspider|yandexbot|duckduckbot/i) >= 0)
        e.server_ = new ReadonlyRestClient(e.repoInfo_,((t,n,r,i)=>{
            repoOnDataUpdate(e, t, n, r, i)
        }
        ),e.authTokenProvider_,e.appCheckProvider_),
        setTimeout((()=>repoOnConnectStatus(e, !0)), 0);
    else {
        if (null != n) {
            if ("object" != typeof n)
        ...
        ),e.authTokenProvider_,e.appCheckProvider_,n),
    ...
    e.statsReporter_ = function statsManagerGetOrCreateReporter(e, t) {
        ...
        return S[n] || (S[n] = t()),
        S[n]
    }(e.repoInfo_, (()=>new StatsReporter(e.stats_,e.server_))),
    e.infoData_ = new SnapshotHolder,
    e.infoSyncTree_ = new SyncTree({
        startListening: (t,n,r,i)=>{
            let o = [];
            const s = e.infoData_.getNode(t._path);
            return s.isEmpty() || (o = syncTreeApplyServerOverwrite(e.infoSyncTree_, t._path, s),
            setTimeout((()=>{
                i("ok")
            }
            ), 0)),
    ...
    repoUpdateInfo(e, "connected", !1),
    e.serverSyncTree_ = new SyncTree({
...
function repoOnDataUpdate(e, t, n, r, i) {
    ...
    let a = o;
    s.length > 0 && (a = repoRerunTransactions(e, o)),
    eventQueueRaiseEventsForChangedPath(e.eventQueue_, a, s)
}
function repoOnConnectStatus(e, t) {
    repoUpdateInfo(e, "connected", t),
    !1 === t && function repoRunOnDisconnectEvents(e) {
        ...
        e.onDisconnect_ = newSparseSnapshotTree(),
        eventQueueRaiseEventsForChangedPath(e.eventQueue_, newEmptyPath(), r)
    }(e)
}
...
function repoSetWithPriority(e, t, n, r, i) {
    ...
    eventQueueQueueEvents(e.eventQueue_, c),
    e.server_.put(t.toString(), s.val(!0), ((n,r)=>{
        const o = "ok" === n;
        o || warn("set at " + t + " failed: " + n);
        const s = syncTreeAckUserWrite(e.serverSyncTree_, h, !o);
        eventQueueRaiseEventsForChangedPath(e.eventQueue_, t, s),
        repoCallOnCompleteCallback(e, i, n, r)
    }
    ));
    const d = repoAbortTransactions(e, t);
    repoRerunTransactions(e, d),
    eventQueueRaiseEventsForChangedPath(e.eventQueue_, d, [])
}
function repoOnDisconnectCancel(e, t, n) {
    e.server_.onDisconnectCancel(t.toString(), ((r,i)=>{
        "ok" === r && sparseSnapshotTreeForget(e.onDisconnect_, t),
        repoCallOnCompleteCallback(e, n, r, i)
    }
    ))
}
function repoOnDisconnectSet(e, t, n, r) {
    ...
    e.server_.onDisconnectPut(t.toString(), i.val(!0), ((n,o)=>{
        "ok" === n && sparseSnapshotTreeRemember(e.onDisconnect_, t, i),
        repoCallOnCompleteCallback(e, r, n, o)
    }
    ))
}
function repoRemoveEventCallbackForQuery(e, t, n) {
    let r;
    r = ".info" === pathGetFront(t._path) ? syncTreeRemoveEventRegistration(e.infoSyncTree_, t, n) : syncTreeRemoveEventRegistration(e.serverSyncTree_, t, n),
...
function repoSendReadyTransactions(e, t=e.transactionQueueTree_) {
    if (t || repoPruneCompletedTransactionsBelowNode(e, t),
    treeGetValue(t)) {
        ...
        n.every((e=>0 === e.status)) && function repoSendTransactionQueue(e, t, n) {
            ...
            for (let e = 0; e < n.length; e++) {
                const r = n[e];
                assert(0 === r.status, "tryToSendTransactionQueue_: items in queue should all be run."),
                r.status = 1,
                r.retryCount++;
            ...
            e.server_.put(l.toString(), a, (r=>{
                ...
                if ("ok" === r) {
                    ...
                    for (let t = 0; t < n.length; t++)
                        n[t].status = 2,
                        i = i.concat(syncTreeAckUserWrite(e.serverSyncTree_, n[t].currentWriteId)),
                        n[t].onComplete && r.push((()=>n[t].onComplete(null, !0, n[t].currentOutputSnapshotResolved))),
                        n[t].unwatcher();
                    repoPruneCompletedTransactionsBelowNode(e, treeSubTree(e.transactionQueueTree_, t)),
                    repoSendReadyTransactions(e, e.transactionQueueTree_),
                    eventQueueRaiseEventsForChangedPath(e.eventQueue_, t, i);
                    for (let e = 0; e < r.length; e++)
                        exceptionGuard(r[e])
                } else {
                    if ("datastale" === r)
        ...
        treeHasChildren(t) && treeForEachChild(t, (t=>{
...
function repoRerunTransactions(e, t) {
    ...
    return function repoRerunTransactionQueue(e, t, n) {
        ...
        for (let a = 0; a < t.length; a++) {
            ...
            let c, d = !1;
            if (assert(null !== h, "rerunTransactionsUnderNode_: relativePath should not be null."),
            4 === l.status)
                d = !0,
                c = l.abortReason,
                i = i.concat(syncTreeAckUserWrite(e.serverSyncTree_, l.currentWriteId, !0));
            else if (0 === l.status)
                if (l.retryCount >= 25)
                    d = !0,
                    c = "maxretry",
                    ...
                    if (void 0 !== r) {
                        ...
                        l.currentWriteId = repoGetNextWriteId(e),
                        o.splice(o.indexOf(s), 1),
                        i = i.concat(syncTreeApplyUserOverwrite(e.serverSyncTree_, l.path, h, l.currentWriteId, l.applyLocally)),
                        i = i.concat(syncTreeAckUserWrite(e.serverSyncTree_, s, !0))
                    } else
                        d = !0,
                        c = "nodata",
                        i = i.concat(syncTreeAckUserWrite(e.serverSyncTree_, l.currentWriteId, !0))
                }
            eventQueueRaiseEventsForChangedPath(e.eventQueue_, n, i),
            i = [],
            d && (t[a].status = 2,
            s = t[a].unwatcher,
            setTimeout(s, Math.floor(0)),
            t[a].onComplete && ("nodata" === c ? r.push((()=>t[a].onComplete(null, !1, t[a].currentInputSnapshot))) : r.push((()=>t[a].onComplete(new Error(c), !1, null)))))
        }
        var s;
        ...
        for (let e = 0; e < r.length; e++)
            exceptionGuard(r[e]);
        repoSendReadyTransactions(e, e.transactionQueueTree_)
    }(e, repoBuildTransactionQueue(e, n), r),
    r
}
function repoGetAncestorTransactionNode(e, t) {
    ...
    for (n = pathGetFront(t); null !== n && void 0 === treeGetValue(r); )
        r = treeSubTree(r, n),
        n = pathGetFront(t = pathPopFront(t));
    return r
}
function repoBuildTransactionQueue(e, t) {
    const n = [];
    return repoAggregateTransactionQueuesForNode(e, t, n),
...
function repoPruneCompletedTransactionsBelowNode(e, t) {
    ...
    if (n) {
        let e = 0;
        for (let t = 0; t < n.length; t++)
            2 !== n[t].status && (n[e] = n[t],
            e++);
        n.length = e,
        treeSetValue(t, n.length > 0 ? n : void 0)
    }
    treeForEachChild(t, (t=>{
...
function repoAbortTransactions(e, t) {
    ...
    repoAbortTransactionsOnNode(e, r),
    treeForEachDescendant(r, (t=>{
        repoAbortTransactionsOnNode(e, t)
    }
    )),
    n
...
function repoAbortTransactionsOnNode(e, t) {
    ...
    if (n) {
        ...
        let i = []
          , o = -1;
        for (let t = 0; t < n.length; t++)
            3 === n[t].status || (1 === n[t].status ? (assert(o === t - 1, "All SENT items should be at beginning of queue."),
            o = t,
            n[t].status = 3,
            n[t].abortReason = "set") : (assert(0 === n[t].status, "Unexpected transaction status in abort"),
            n[t].unwatcher(),
            i = i.concat(syncTreeAckUserWrite(e.serverSyncTree_, n[t].currentWriteId, !0)),
            n[t].onComplete && r.push(n[t].onComplete.bind(null, new Error("set"), !1, null))));
        -1 === o ? treeSetValue(t, void 0) : n.length = o + 1,
        eventQueueRaiseEventsForChangedPath(e.eventQueue_, treeGetPath(t), i);
        for (let e = 0; e < r.length; e++)
            exceptionGuard(r[e])
    }
}
const parseRepoInfo = function(e, t) {
    const n = parseDatabaseURL(e)
      , r = n.namespace;
    "firebase.com" === n.domain && fatal(n.host + " is no longer supported. Please use <YOUR FIREBASE>.firebaseio.com instead"),
    r && "undefined" !== r || "localhost" === n.domain || fatal("Cannot parse Firebase url. Please use https://<YOUR FIREBASE>.firebaseio.com"),
    n.secure || "undefined" != typeof window && window.location && window.location.protocol && -1 !== window.location.protocol.indexOf("https:") && warn("Insecure Firebase access from a secure page. Please use https in calls to new Firebase().");
  ...
  , parseDatabaseURL = function(e) {
    ...
    if ("string" == typeof e) {
        let h = e.indexOf("//");
        h >= 0 && (a = e.substring(0, h - 1),
        e = e.substring(h + 2));
        let c = e.indexOf("/");
        -1 === c && (c = e.length);
        let d = e.indexOf("?");
        -1 === d && (d = e.length),
        t = e.substring(0, Math.min(c, d)),
        c < d && (i = function decodePath(e) {
            let t = "";
            const n = e.split("/");
            for (let e = 0; e < n.length; e++)
                if (n[e].length > 0) {
        ...
        h = t.indexOf(":"),
        h >= 0 ? (s = "https" === a || "wss" === a,
        l = parseInt(t.substring(h + 1), 10)) : h = t.length;
        const p = t.slice(0, h);
        if ("localhost" === p.toLowerCase())
            n = "localhost";
  ...
  , K = function() {
    ...
    return function(n) {
        ...
        for (i = 0; i < 12; i++)
            s += z.charAt(t[i]);
        return assert(20 === s.length, "nextPushId: Length should be 20."),
        s
    }
}();
class DataEvent {
...
class CallbackContext {
    ...
    onCancel(e) {
        return assert(this.hasCancelCallback, "Raising a cancel event on a listener with no cancel callback"),
...
class OnDisconnect {
    ...
    cancel() {
        const e = new Deferred;
        return repoOnDisconnectCancel(this._repo, this._path, e.wrapCallback((()=>{}
        ))),
        e.promise
    }
    remove() {
        ...
        const e = new Deferred;
        return repoOnDisconnectSet(this._repo, this._path, null, e.wrapCallback((()=>{}
        ))),
        e.promise
    }
    set(e) {
        ...
        const t = new Deferred;
        return repoOnDisconnectSet(this._repo, this._path, e, t.wrapCallback((()=>{}
        ))),
        t.promise
    }
    setWithPriority(e, t) {
        validateWritablePath("OnDisconnect.setWithPriority", this._path),
        validateFirebaseDataArg("OnDisconnect.setWithPriority", e, this._path, !1),
        ...
        return function repoOnDisconnectSetWithPriority(e, t, n, r, i) {
            ...
            e.server_.onDisconnectPut(t.toString(), o.val(!0), ((n,r)=>{
                "ok" === n && sparseSnapshotTreeRemember(e.onDisconnect_, t, o),
                repoCallOnCompleteCallback(0, i, n, r)
            }
            ))
        }(this._repo, this._path, e, t, n.wrapCallback((()=>{}
        ))),
        n.promise
    }
    update(e) {
        validateWritablePath("OnDisconnect.update", this._path),
        validateFirebaseMergeDataArg("OnDisconnect.update", e, this._path, !1);
        const t = new Deferred;
        return function repoOnDisconnectUpdate(e, t, n, r) {
            if (isEmpty(n))
                return log("onDisconnect().update() called with empty data.  Don't do anything."),
                void repoCallOnCompleteCallback(0, r, "ok", void 0);
        ...
        }(this._repo, this._path, e, t.wrapCallback((()=>{}
        ))),
        t.promise
    }
}
class QueryImpl {
    ...
    isEqual(e) {
        if (!((e = getModularInstance(e))instanceof QueryImpl))
            return !1;
...
function validateQueryEndpoints(e) {
    let t = null
      , n = null;
    if (e.hasStart() && (t = e.getIndexStartValue()),
    ...
    e.getIndex() === b) {
        ...
        if (e.hasStart()) {
            if (e.getIndexStartName() !== v)
                throw new Error(r);
            if ("string" != typeof t)
                throw new Error(i)
        }
        if (e.hasEnd()) {
            if (e.getIndexEndName() !== C)
                throw new Error(r);
            if ("string" != typeof n)
                throw new Error(i)
        }
    } else if (e.getIndex() === x) {
        if (null != t && !isValidPriority(t) || null != n && !isValidPriority(n))
            throw new Error("Query: When ordering by priority, the first argument passed to startAt(), startAfter() endAt(), endBefore(), or equalTo() must be a valid priority value (null, a number, or a string).")
    } else if (assert(e.getIndex()instanceof PathIndex || e.getIndex() === W, "unknown index type."),
...
function ref(e, t) {
    return (e = getModularInstance(e))._checkNotDeleted("ref"),
...
function refFromURL(e, t) {
    ...
    const r = n.repoInfo;
    return e._repo.repoInfo_.isCustomHost() || r.host === e._repo.repoInfo_.host || fatal("refFromURL: Host name does not match the current database: (found " + r.host + " but expected " + e._repo.repoInfo_.host + ")"),
    ref(e, n.path.toString())
}
function child(e, t) {
    var n, r, i, o;
    return null === pathGetFront((e = getModularInstance(e))._path) ? (n = "child",
    r = "path",
    o = !1,
    (i = t) && (i = i.replace(/^\/*\.info(\/|$)/, "/")),
    validatePathString(n, r, i, o)) : validatePathString("child", "path", t, !1),
    new ReferenceImpl(e._repo,pathChild(e._path, t))
}
function onDisconnect(e) {
    return e = getModularInstance(e),
    new OnDisconnect(e._repo,e._path)
}
function push(e, t) {
    ...
    const n = repoServerTime(e._repo)
      ...
      , o = child(e, r);
    let s;
    return s = null != t ? set(o, t).then((()=>o)) : Promise.resolve(o),
    i.then = s.then.bind(s),
    i.catch = s.then.bind(s, void 0),
    i
}
function remove(e) {
    return validateWritablePath("remove", e._path),
    set(e, null)
}
function set(e, t) {
    e = getModularInstance(e),
    ...
    const n = new Deferred;
    return repoSetWithPriority(e._repo, e._path, t, null, n.wrapCallback((()=>{}
    ))),
    n.promise
}
function setPriority(e, t) {
    ...
    const n = new Deferred;
    return repoSetWithPriority(e._repo, pathChild(e._path, ".priority"), t, null, n.wrapCallback((()=>{}
    ))),
    n.promise
}
function setWithPriority(e, t, n) {
    if (validateWritablePath("setWithPriority", e._path),
    ...
    return repoSetWithPriority(e._repo, e._path, t, n, r.wrapCallback((()=>{}
    ))),
    r.promise
}
function update(e, t) {
    ...
    return function repoUpdate(e, t, n, r) {
        ...
        if (each(n, ((n,r)=>{
            i = !1,
            s[n] = resolveDeferredValueTree(pathChild(t, n), nodeFromJSON(r), e.serverSyncTree_, o)
        }
        )),
        i)
            log("update() called with empty data.  Don't do anything."),
            repoCallOnCompleteCallback(0, r, "ok", void 0);
        else {
            const i = repoGetNextWriteId(e)
              , o = syncTreeApplyUserMerge(e.serverSyncTree_, t, s, i);
            eventQueueQueueEvents(e.eventQueue_, o),
            e.server_.merge(t.toString(), n, ((n,o)=>{
                ...
                repoCallOnCompleteCallback(0, r, n, o)
            }
            )),
            each(n, (n=>{
    ...
    }(e._repo, e._path, t, n.wrapCallback((()=>{}
    ))),
    n.promise
}
function get(e) {
    ...
    return function repoGetValue(e, t, n) {
        ...
        return null != r ? Promise.resolve(r) : e.server_.get(t).then((r=>{
            ...
            let o;
            if (syncTreeAddEventRegistration(e.serverSyncTree_, t, n, !0),
            t._queryParams.loadsAllData())
                o = syncTreeApplyServerOverwrite(e.serverSyncTree_, t._path, i);
            else {
                const n = syncTreeTagForQuery(e.serverSyncTree_, t);
                o = syncTreeApplyTaggedQueryOverwrite(e.serverSyncTree_, t._path, i, n)
            }
            return eventQueueRaiseEventsForChangedPath(e.eventQueue_, t._path, o),
            syncTreeRemoveEventRegistration(e.serverSyncTree_, t, n, null, !0),
            i
        }
        ), (n=>(repoLog(e, "get for query " + stringify(t) + " failed: " + n),
...
function addEventListener(e, t, n, r, i) {
    let o;
    if ("object" == typeof r && (o = void 0,
    i = r),
    "function" == typeof r && (o = r),
    i && i.onlyOnce) {
        const t = n
          , onceCallback = (n,r)=>{
            repoRemoveEventCallbackForQuery(e._repo, e, a),
            t(n, r)
        }
        ;
        onceCallback.userCallback = n.userCallback,
        onceCallback.context = n.context,
        n = onceCallback
    }
    ...
    return function repoAddEventCallbackForQuery(e, t, n) {
        let r;
        r = ".info" === pathGetFront(t._path) ? syncTreeAddEventRegistration(e.infoSyncTree_, t, n) : syncTreeAddEventRegistration(e.serverSyncTree_, t, n),
        eventQueueRaiseEventsAtPath(e.eventQueue_, t._path, r)
    }(e._repo, e, a),
    ()=>repoRemoveEventCallbackForQuery(e._repo, e, a)
}
...
function off(e, t, n) {
    ...
    "value" === t ? r = new ValueEventRegistration(i) : t && (r = new ChildEventRegistration(t,i)),
...
function endAt(e, t) {
    return validateKey("endAt", "key", t, !0),
    new QueryEndAtConstraint(e,t)
}
class QueryEndBeforeConstraint extends QueryConstraint {
    ...
    _apply(e) {
        ...
        const t = function queryParamsEndBefore(e, t, n) {
            let r;
            return r = e.index_ === b || n ? queryParamsEndAt(e, t, n) : queryParamsEndAt(e, t, v),
            r.endBeforeSet_ = !0,
            r
...
function endBefore(e, t) {
    return validateKey("endBefore", "key", t, !0),
...
function startAt(e=null, t) {
    return validateKey("startAt", "key", t, !0),
    new QueryStartAtConstraint(e,t)
}
class QueryStartAfterConstraint extends QueryConstraint {
    ...
    _apply(e) {
        ...
        const t = function queryParamsStartAfter(e, t, n) {
            let r;
            return r = e.index_ === b || n ? queryParamsStartAt(e, t, n) : queryParamsStartAt(e, t, C),
            r.startAfterSet_ = !0,
            r
        }(e._queryParams, this._value, this._key);
        if (validateLimit(t),
...
function startAfter(e, t) {
    return validateKey("startAfter", "key", t, !0),
...
class QueryOrderByChildConstraint extends QueryConstraint {
    ...
    _apply(e) {
        ...
        return validateQueryEndpoints(r),
        new QueryImpl(e._repo,e._path,r,!0)
    }
}
function orderByChild(e) {
    ...
    return validatePathString("orderByChild", "path", e, !1),
...
class QueryOrderByKeyConstraint extends QueryConstraint {
    _apply(e) {
        ...
        return validateQueryEndpoints(t),
        new QueryImpl(e._repo,e._path,t,!0)
    }
}
function orderByKey() {
...
class QueryEqualToValueConstraint extends QueryConstraint {
    ...
    _apply(e) {
        if (validateFirebaseDataArg("equalTo", this._value, e._path, !1),
        e._queryParams.hasStart())
...
function equalTo(e, t) {
    return validateKey("equalTo", "key", t, !0),
...
!function syncPointSetReferenceConstructor(e) {
    assert(!U, "__referenceConstructor has already been defined"),
    U = e
}(ReferenceImpl),
function syncTreeSetReferenceConstructor(e) {
    assert(!B, "__referenceConstructor has already been defined"),
    B = e
}(ReferenceImpl);
const Y = {};
let $ = !1;
function repoManagerDatabaseFromApp(e, t, n, r, i) {
    ...
    void 0 === o && (e.options.projectId || fatal("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),
    log("Using default host for project ", e.options.projectId),
    o = `${e.options.projectId}-default-rtdb.firebaseio.com`);
    let s, a, l = parseRepoInfo(o, i), h = l.repoInfo;
    "undefined" != typeof process && process.env && (a = process.env.FIREBASE_DATABASE_EMULATOR_HOST),
    a ? (s = !0,
    o = `http://${a}?ns=${h.namespace}`,
    l = parseRepoInfo(o, i),
    h = l.repoInfo) : s = !l.repoInfo.secure;
    const c = i && s ? new EmulatorTokenProvider(EmulatorTokenProvider.OWNER) : new FirebaseAuthTokenProvider(e.name,e.options,t);
    validateUrl("Invalid Firebase Database URL", l),
    pathIsEmpty(l.path) || fatal("Database URL must point to the root of a Firebase Database (not including a child path).");
...
class Database {
    ...
    get _repo() {
        return this._instanceStarted || (repoStart(this._repoInternal, this.app.options.appId, this.app.options.databaseAuthVariableOverride),
        this._instanceStarted = !0),
        this._repoInternal
    }
    get _root() {
        return this._rootInternal || (this._rootInternal = new ReferenceImpl(this._repo,newEmptyPath())),
        this._rootInternal
    }
    _delete() {
        return null !== this._rootInternal && (!function repoManagerDeleteRepo(e, t) {
            const n = Y[t];
            n && n[e.key] === e || fatal(`Database ${t}(${e.repoInfo_}) has already been deleted.`),
            repoInterrupt(e),
            delete n[e.key]
...
function connectDatabaseEmulator(e, t, n, r={}) {
    ...
    e._instanceStarted && fatal("Cannot call useEmulator() after instance has already been initialized.");
    const i = e._repoInternal;
    let o;
    if (i.repoInfo_.nodeAdmin)
        r.mockUserToken && fatal('mockUserToken is not supported by the Admin SDK. For client access with mock users, please use the "firebase" package instead of "firebase-admin".'),
    ...
    !function repoManagerApplyEmulatorSettings(e, t, n, r) {
        e.repoInfo_ = new RepoInfo(`${t}:${n}`,!1,e.repoInfo_.namespace,e.repoInfo_.webSocketOnly,e.repoInfo_.nodeAdmin,e.repoInfo_.persistenceKey,e.repoInfo_.includeNamespaceInQueryParams,!0),
...
function runTransaction(e, t, n) {
    ...
    validateWritablePath("Reference.transaction", e._path),
    ".length" === e.key || ".keys" === e.key)
    ...
    return function repoStartTransaction(e, t, n, r, i, o) {
        ...
        if (void 0 === l)
            ...
            validateFirebaseData("transaction failed: Data returned ", l, s.path),
            s.status = 0;
            ...
            r.push(s),
            treeSetValue(n, r),
            "object" == typeof l && null !== l && contains(l, ".priority") ? (i = safeGet(l, ".priority"),
            assert(isValidPriority(i), "Invalid priority returned by transaction. Priority must be a valid string, finite number, server value, or null.")) : i = (syncTreeCalcCompleteEventCache(e.serverSyncTree_, t) || ChildrenNode.EMPTY_NODE).getPriority().val();
            const o = repoGenerateServerValues(e)
              , h = nodeFromJSON(l, i)
              , c = resolveDeferredValueSnapshot(h, a, o);
            s.currentOutputSnapshotRaw = h,
            s.currentOutputSnapshotResolved = c,
            s.currentWriteId = repoGetNextWriteId(e);
            const d = syncTreeApplyUserOverwrite(e.serverSyncTree_, t, c, s.currentWriteId, s.applyLocally);
            eventQueueRaiseEventsForChangedPath(e.eventQueue_, t, d),
            repoSendReadyTransactions(e, e.transactionQueueTree_)
        }
    }(e._repo, e._path, t, ((t,n,r)=>{
        let i = null;
        t ? o.reject(t) : (i = new DataSnapshot(r,new ReferenceImpl(e._repo,e._path),x),
        o.resolve(new TransactionResult(n,i)))
    }
    ), s, i),
    o.promise
}
...
function _initStandalone({app: e, url: t, version: n, customAuthImpl: r, customAppCheckImpl: i, nodeAdmin: o=!1}) {
    setSDKVersion(n);
    const s = new ComponentContainer("database-standalone")
      , a = new Provider("auth-internal",s);
    let l;
    return i && (l = new Provider("app-check-internal",s),
    l.setComponent(new Component("app-check-internal",(()=>i),"PRIVATE"))),
    a.setComponent(new Component("auth-internal",(()=>r),"PRIVATE")),
    repoManagerDatabaseFromApp(e, a, l, t, o)
}
!function registerDatabase(e) {
    setSDKVersion(r),
    t(new Component("database",((e,{instanceIdentifier: t})=>repoManagerDatabaseFromApp(e.getProvider("app").getImmediate(), e.getProvider("auth-internal"), e.getProvider("app-check-internal"), t)),"PUBLIC").setMultipleInstances(!0)),
    n(d, "1.0.1", e),
    n(d, "1.0.1", "esm2017")
}();
