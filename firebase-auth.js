import {_getProvider, _registerComponent as e, registerVersion as t, getApp as r, SDK_VERSION as n} from "/firebase-app.js";
const i = {
    byteToCharMap_: null,
    charToByteMap_: null,
    ...
    encodeString(e, t) {
        return this.HAS_NATIVE_SUPPORT && !t ? btoa(e) : this.encodeByteArray(function(e) {
            ...
            for (let n = 0; n < e.length; n++) {
                ...
                t[r++] = 63 & i | 128) : 55296 == (64512 & i) && n + 1 < e.length && 56320 == (64512 & e.charCodeAt(n + 1)) ? (i = 65536 + ((1023 & i) << 10) + (1023 & e.charCodeAt(++n)),
                t[r++] = i >> 18 | 240,
                t[r++] = i >> 12 & 63 | 128,
                t[r++] = i >> 6 & 63 | 128,
...
function _assertInstanceOf(e, t, r) {
    if (!(t instanceof r))
        throw r.name !== t.constructor.name && _fail(e, "argument-error"),
        _errorWithCustomMessage(e, "argument-error", `Type of ${t.constructor.name} does not match expected instance.Did you pass a reference from a different Auth SDK?`)
}
function createErrorInternal(e, ...t) {
    if ("string" != typeof e) {
        const r = t[0]
          , n = [...t.slice(1)];
        return n[0] && (n[0].appName = e.name),
        e._errorFactory.create(r, ...n)
    }
    return _.create(e, ...t)
}
function _assert(e, t, ...r) {
    if (!e)
        throw createErrorInternal(t, ...r)
}
...
class Delay {
    constructor(e, t) {
        this.shortDelay = e,
        this.longDelay = t,
        debugAssert(t > e, "Short delay should be less than long delay!"),
        this.isMobile = function isMobileCordova() {
...
async function _performApiRequest(e, t, r, n, i={}) {
    return _performFetchWithErrorHandling(e, i, (async()=>{
        ...
        FetchProvider.fetch()(_getFinalTarget(e, e.config.apiHost, r, o), Object.assign({
            method: t,
            headers: a,
...
async function _performFetchWithErrorHandling(e, t, r) {
    ...
    try {
        ...
        if ("needConfirmation"in s)
            throw _makeTaggedError(e, "account-exists-with-different-credential", s);
            ...
            return s;
        {
            ...
            if ("FEDERATED_USER_ID_ALREADY_LINKED" === r)
                throw _makeTaggedError(e, "credential-already-in-use", s);
            if ("EMAIL_EXISTS" === r)
                throw _makeTaggedError(e, "email-already-in-use", s);
            if ("USER_DISABLED" === r)
                throw _makeTaggedError(e, "user-disabled", s);
            const a = n[r] || r.toLowerCase().replace(/[_\s]+/g, "-");
            if (o)
                throw _errorWithCustomMessage(e, a, o);
            _fail(e, a)
        }
    } catch (t) {
        if (t instanceof FirebaseError)
            throw t;
...
class NetworkTimeout {
    constructor(e) {
        ...
        this.promise = new Promise(((e,t)=>{
            this.timer = setTimeout((()=>t(_createError(this.auth, "network-request-failed"))), y.get())
        }
        ))
    }
    clearNetworkTimeout() {
...
function _makeTaggedError(e, t, r) {
    ...
    return i.customData._tokenResponse = r,
    i
}
function isV2(e) {
    ...
    getProviderEnforcementState(e) {
        ...
        for (const t of this.recaptchaEnforcementState)
            if (t.provider && t.provider === e)
                return _parseEnforcementState(t.enforcementState);
        return null
    }
    isProviderEnabled(e) {
...
function _parseToken(e) {
    ...
    try {
        ...
        return e ? JSON.parse(e) : (_logError("Failed to decode base64 JWT payload"),
        null)
    } catch (e) {
        return _logError("Caught error parsing JWT payload as JSON", null == e ? void 0 : e.toString()),
        null
    }
}
async function _logoutIfInvalidated(e, t, r=!1) {
    ...
    try {
        ...
        throw t instanceof FirebaseError && function isUserInvalidated({code: e}) {
...
class StsTokenManager {
    ...
    updateFromServerResponse(e) {
        ...
        const t = "expiresIn"in e && void 0 !== e.expiresIn ? Number(e.expiresIn) : function _tokenExpiresIn(e) {
            ...
            return _assert(t, "internal-error"),
            _assert(void 0 !== t.exp, "internal-error"),
            _assert(void 0 !== t.iat, "internal-error"),
            Number(t.exp) - Number(t.iat)
        }(e.idToken);
        this.updateTokensAndExpiration(e.idToken, e.refreshToken, t)
    }
    async getToken(e, t=!1) {
        return _assert(!this.accessToken || this.refreshToken, e, "user-token-expired"),
    ...
    async refresh(e, t) {
        const {accessToken: r, refreshToken: n, expiresIn: i} = await async function requestStsToken(e, t) {
    ...
    static fromJSON(e, t) {
        ...
        s.refreshToken = r),
        n && (_assert("string" == typeof n, "internal-error", {
            appName: e
        }),
        s.accessToken = n),
        i && (_assert("number" == typeof i, "internal-error", {
            appName: e
        }),
        s.expirationTime = i),
        s
...
class UserImpl {
    constructor(e) {
        var {uid: t, auth: r, stsTokenManager: n} = e
          , i = __rest(e, ["uid", "auth", "stsTokenManager"]);
    ...
    async getIdToken(e) {
        ...
        return _assert(t, this.auth, "internal-error"),
    ...
    _assign(e) {
        this !== e && (_assert(this.uid === e.uid, this.auth, "internal-error"),
    ...
    static _fromJSON(e, t) {
        ...
        const u = null !== (r = t.displayName) && void 0 !== r ? r : void 0
          ...
          , {uid: I, emailVerified: v, isAnonymous: T, providerData: y, stsTokenManager: E} = t;
        _assert(I && E, e, "internal-error");
        const A = StsTokenManager.fromJSON(this.name, E);
        _assert("string" == typeof I, e, "internal-error"),
        assertStringOrUndefined(u, e.name),
        assertStringOrUndefined(l, e.name),
        _assert("boolean" == typeof v, e, "internal-error"),
        _assert("boolean" == typeof T, e, "internal-error"),
        assertStringOrUndefined(h, e.name),
        assertStringOrUndefined(p, e.name),
        assertStringOrUndefined(f, e.name),
        assertStringOrUndefined(m, e.name),
        assertStringOrUndefined(g, e.name),
        assertStringOrUndefined(_, e.name);
        ...
        return y && Array.isArray(y) && (w.providerData = y.map((e=>Object.assign({}, e)))),
        m && (w._redirectEventId = m),
        w
    }
    static async _fromIdTokenResponse(e, t, r=!1) {
        ...
        return await _reloadWithoutSaving(i),
        i
    }
}
const E = new Map;
function _getInstance(e) {
    ...
    let t = E.get(e);
    return t ? (debugAssert(t instanceof e, "Instance stored in cache mismatched with class"),
    t) : (t = new e,
    E.set(e, t),
    t)
}
...
class PersistenceUserManager {
    constructor(e, t, r) {
        ...
        this.fullUserKey = _persistenceKeyName(this.userKey, n.apiKey, i),
        this.fullPersistenceKey = _persistenceKeyName("persistence", n.apiKey, i),
    ...
    static async create(e, t, r="authUser") {
        if (!t.length)
            return new PersistenceUserManager(_getInstance(A),e,r);
...
function _getBrowserName(e) {
    ...
    if (_isSafari(t))
        return "Safari";
    if ((t.includes("chrome/") || _isChromeIOS(t)) && !t.includes("edge/"))
        return "Chrome";
    if (_isAndroid(t))
        return "Android";
    {
...
class PasswordPolicyImpl {
    constructor(e) {
        ...
        void 0 !== s.containsLowercaseCharacter && (this.customStrengthOptions.containsLowercaseLetter = s.containsLowercaseCharacter),
        void 0 !== s.containsUppercaseCharacter && (this.customStrengthOptions.containsUppercaseLetter = s.containsUppercaseCharacter),
        void 0 !== s.containsNumericCharacter && (this.customStrengthOptions.containsNumericCharacter = s.containsNumericCharacter),
        void 0 !== s.containsNonAlphanumericCharacter && (this.customStrengthOptions.containsNonAlphanumericCharacter = s.containsNonAlphanumericCharacter),
        this.enforcementState = e.enforcementState,
        "ENFORCEMENT_STATE_UNSPECIFIED" === this.enforcementState && (this.enforcementState = "OFF"),
        this.allowedNonAlphanumericCharacters = null !== (n = null === (r = e.allowedNonAlphanumericCharacters) || void 0 === r ? void 0 : r.join("")) && void 0 !== n ? n : "",
    ...
    validatePassword(e) {
        ...
        a.isValid && (a.isValid = null === (r = a.meetsMaxPasswordLength) || void 0 === r || r),
        a.isValid && (a.isValid = null === (n = a.containsLowercaseLetter) || void 0 === n || n),
    ...
    validatePasswordCharacterOptions(e, t) {
        ...
        for (let n = 0; n < e.length; n++)
            r = e.charAt(n),
            this.updatePasswordCharacterOptionsStatuses(t, r >= "a" && r <= "z", r >= "A" && r <= "Z", r >= "0" && r <= "9", this.allowedNonAlphanumericCharacters.includes(r))
    }
    updatePasswordCharacterOptionsStatuses(e, t, r, n, i) {
        ...
        this.customStrengthOptions.containsNumericCharacter && (e.containsNumericCharacter || (e.containsNumericCharacter = n)),
...
class AuthImpl {
    ...
    _initializeWithPersistence(e, t) {
        return t && (this._popupRedirectResolver = _getInstance(t)),
        this._initializationPromise = this.queue((async()=>{
            var r, n;
            if (!this._deleted && (this.persistenceManager = await PersistenceUserManager.create(this, e),
            !this._deleted)) {
                if (null === (r = this._popupRedirectResolver) || void 0 === r ? void 0 : r._shouldInitProactively)
                    try {
    ...
    async initializeCurrentUser(e) {
        ...
        if (e && this.config.authDomain) {
            ...
            r && r !== s || !(null == o ? void 0 : o.user) || (n = o.user,
            i = !0)
        }
        if (!n)
        ...
        await this.getOrInitRedirectPersistenceManager(),
        this.redirectUser && this.redirectUser._redirectEventId === n._redirectEventId ? this.directlySetCurrentUser(n) : this.reloadAndSetCurrentUserOrClear(n)
    }
    ...
    async updateCurrentUser(e) {
        ...
        return t && _assert(t.auth.config.apiKey === this.config.apiKey, this, "invalid-user-token"),
        this._updateCurrentUser(t && t._clone(this))
    }
    async _updateCurrentUser(e, t=!1) {
        if (!this._deleted)
            return e && _assert(this.tenantId === e.tenantId, this, "tenant-id-mismatch"),
    ...
    async getOrInitRedirectPersistenceManager(e) {
        if (!this.redirectPersistenceManager) {
            ...
            _assert(t, this, "argument-error"),
            this.redirectPersistenceManager = await PersistenceUserManager.create(this, [_getInstance(t._redirectPersistence)], "redirectUser"),
    ...
    async _redirectUserForId(e) {
        ...
        (null === (t = this._currentUser) || void 0 === t ? void 0 : t._redirectEventId) === e ? this._currentUser : (null === (r = this.redirectUser) || void 0 === r ? void 0 : r._redirectEventId) === e ? this.redirectUser : null
    }
    ...
    registerStateListener(e, t, r, n) {
        ...
        if (_assert(o, this, "internal-error"),
        o.then((()=>{
    ...
    async _getAdditionalHeaders() {
        ...
        return n && (t["X-Firebase-AppCheck"] = n),
        t
    }
...
class Subscription {
    constructor(e) {
        this.auth = e,
        this.observer = null,
        this.addObserver = function createSubscribe(e, t) {
    ...
    async verify(e="verify", t=!1) {
        ...
        return new Promise(((e,r)=>{
            (async function retrieveSiteKey(e) {
                ...
                return new Promise((async(t,r)=>{
                    getRecaptchaConfig(e, {
                        ...
                        if (void 0 !== n.recaptchaKey) {
                            ...
                            return null == e.tenantId ? e._agentRecaptchaConfig = r : e._tenantRecaptchaConfigs[e.tenantId] = r,
                            t(r.siteKey)
                        }
                ...
                if (!t && isEnterprise(window.grecaptcha))
                    retrieveRecaptchaToken(n, e, r);
                else {
                    if ("undefined" == typeof window)
                        return void r(new Error("RecaptchaVerifier is only supported in browser"));
                    _loadJS("https://www.google.com/recaptcha/enterprise.js?render=" + n).then((()=>{
                        retrieveRecaptchaToken(n, e, r)
                    }
                    )).catch((e=>{
                        r(e)
...
function initializeAuth(e, t) {
    ...
    if (r.isInitialized()) {
        ...
        if (deepEqual(r.getOptions(), null != t ? t : {}))
            return e;
...
function connectAuthEmulator(e, t, r) {
    const n = _castAuth(e);
    _assert(n._canInitEmulator, n, "emulator-config-failed"),
    _assert(/^https?:\/\//.test(t), n, "invalid-emulator-scheme");
    const i = !!(null == r ? void 0 : r.disableWarnings)
      , s = extractProtocol(t)
      , {host: o, port: a} = function extractHostAndPort(e) {
...
class OAuthCredential extends AuthCredential {
    ...
    static _fromParams(e) {
        ...
        t.secret = e.oauthTokenSecret) : _fail("argument-error"),
        t
    }
    toJSON() {
        return {
...
class PhoneAuthCredential extends AuthCredential {
    ...
    _linkToIdToken(e, t) {
        return async function linkWithPhoneNumber$1(e, t) {
            ...
            if (r.temporaryProof)
                throw _makeTaggedError(e, "account-exists-with-different-credential", r);
            return r
        }(e, Object.assign({
            idToken: t
    ...
    _makeVerificationRequest() {
        const {temporaryProof: e, phoneNumber: t, verificationId: r, verificationCode: n} = this.params;
        return e && t ? {
            temporaryProof: e,
            phoneNumber: t
        } : {
    ...
    static fromJSON(e) {
        ...
        const {verificationId: t, verificationCode: r, phoneNumber: n, temporaryProof: i} = e;
...
class EmailAuthProvider {
    ...
    static credentialWithLink(e, t) {
        ...
        return _assert(r, "argument-error"),
        EmailAuthCredential._fromEmailAndCode(e, r.code, r.tenantId)
    }
}
...
class OAuthProvider extends BaseOAuthProvider {
    static credentialFromJSON(e) {
        const t = "string" == typeof e ? JSON.parse(e) : e;
        return _assert("providerId"in t && "signInMethod"in t, "argument-error"),
        OAuthCredential._fromParams(t)
    }
    credential(e) {
    ...
    _credential(e) {
        return _assert(e.idToken || e.accessToken, "argument-error"),
        OAuthCredential._fromParams(Object.assign(Object.assign({}, e), {
            providerId: this.providerId,
    ...
    static oauthCredentialFromTaggedObject({_tokenResponse: e}) {
        if (!e)
            return null;
        const {oauthIdToken: t, oauthAccessToken: r, oauthTokenSecret: n, pendingToken: i, nonce: s, providerId: o} = e;
        if (!(r || n || t || i))
            return null;
        if (!o)
            return null;
...
class SAMLAuthCredential extends AuthCredential {
    ...
    static fromJSON(e) {
        const t = "string" == typeof e ? JSON.parse(e) : e
          , {providerId: r, signInMethod: n, pendingToken: i} = t;
...
class SAMLAuthProvider extends FederatedAuthProvider {
    constructor(e) {
        _assert(e.startsWith("saml."), "argument-error"),
        super(e)
    }
    static credentialFromResult(e) {
    ...
    static credentialFromJSON(e) {
        ...
        return _assert(t, "argument-error"),
        t
    }
...
async function signInAnonymously(e) {
    var t;
    const r = _castAuth(e);
    if (await r._initializationPromise,
    null === (t = r.currentUser) || void 0 === t ? void 0 : t.isAnonymous)
        return new UserCredentialImpl({
            user: r.currentUser,
            providerId: null,
    ...
    return await r._updateCurrentUser(i.user),
    i
}
...
async function unlink(e, t) {
    ...
    const {providerUserInfo: n} = await async function deleteLinkedAccounts(e, t) {
        return _performApiRequest(e, "POST", "/v1/accounts:update", t)
    }(r.auth, {
    ...
    return r.providerData = r.providerData.filter((e=>i.has(e.providerId))),
...
async function _reauthenticate(e, t, r=!1) {
    ...
    try {
        ...
        const {sub: a} = o;
        return _assert(e.uid === a, n, "user-mismatch"),
        UserCredentialImpl._forOperation(e, i, s)
    } catch (e) {
        throw "auth/user-not-found" === (null == e ? void 0 : e.code) && _fail(n, "user-mismatch"),
        e
    }
}
async function _signInWithCredential(e, t, r=!1) {
    ...
    return r || await e._updateCurrentUser(s.user),
    s
}
...
async function linkWithCredential(e, t) {
    const r = getModularInstance(e);
    return await _assertLinkedStatus(!1, r, t.providerId),
    _link$1(r, t)
}
...
function _setActionCodeSettingsOnRequest(e, t, r) {
    var n;
    _assert((null === (n = r.url) || void 0 === n ? void 0 : n.length) > 0, e, "invalid-continue-uri"),
    _assert(void 0 === r.dynamicLinkDomain || r.dynamicLinkDomain.length > 0, e, "invalid-dynamic-link-domain"),
    t.continueUrl = r.url,
    t.dynamicLinkDomain = r.dynamicLinkDomain,
    t.canHandleCodeInApp = r.handleCodeInApp,
    r.iOS && (_assert(r.iOS.bundleId.length > 0, e, "missing-ios-bundle-id"),
    t.iOSBundleId = r.iOS.bundleId),
    r.android && (_assert(r.android.packageName.length > 0, e, "missing-android-pkg-name"),
...
async function sendPasswordResetEmail(e, t, r) {
    ...
    r && _setActionCodeSettingsOnRequest(n, i, r),
    await handleRecaptchaFlow(n, i, "getOobCode", sendPasswordResetEmail$1)
}
async function confirmPasswordReset(e, t, r) {
    await resetPassword(getModularInstance(e), {
        ...
        throw "auth/password-does-not-meet-requirements" === t.code && recachePasswordPolicy(e),
        t
    }
    ))
}
...
async function checkActionCode(e, t) {
    const r = getModularInstance(e)
      ...
      , i = n.requestType;
    switch (_assert(i, r, "internal-error"),
    i) {
    case "EMAIL_SIGNIN":
        break;
...
async function verifyPasswordResetCode(e, t) {
    const {data: r} = await checkActionCode(getModularInstance(e), t);
    return r.email
}
async function createUserWithEmailAndPassword(e, t, r) {
    ...
    return await n._updateCurrentUser(o.user),
    o
}
...
async function sendSignInLinkToEmail(e, t, r) {
    ...
    !function setActionCodeSettings(e, t) {
        _assert(t.handleCodeInApp, n, "argument-error"),
        t && _setActionCodeSettingsOnRequest(n, e, t)
    }(i, r),
    await handleRecaptchaFlow(n, i, "getOobCode", sendSignInLinkToEmail$1)
}
...
async function signInWithEmailLink(e, t, r) {
    ...
    return _assert(i._tenantId === (n.tenantId || null), n, "tenant-id-mismatch"),
    signInWithCredential(n, i)
}
async function fetchSignInMethodsForEmail(e, t) {
    const r = {
      ...
      , {signinMethods: n} = await async function createAuthUri(e, t) {
...
async function sendEmailVerification(e, t) {
    ...
    const {email: i} = await async function sendEmailVerification$1(e, t) {
        return sendOobCode(e, t)
    }(r.auth, n);
...
async function verifyBeforeUpdateEmail(e, t, r) {
    ...
    const {email: s} = await async function verifyAndChangeEmail(e, t) {
        return sendOobCode(e, t)
    }(n.auth, i);
...
async function updateProfile(e, {displayName: t, photoURL: r}) {
    ...
    const o = n.providerData.find((({providerId: e})=>"password" === e));
    o && (o.displayName = n.displayName,
...
async function updateEmailOrPassword(e, t, r) {
    ...
    t && (i.email = t),
    r && (i.password = r);
    const s = await _logoutIfInvalidated(e, updateEmailPassword(n, i));
...
function getAdditionalUserInfo(e) {
    const {user: t, _tokenResponse: r} = e;
    return t.isAnonymous && !r ? {
        ...
        if (!n && (null == e ? void 0 : e.idToken)) {
            ...
            if (n)
                return new GenericAdditionalUserInfo(s,"anonymous" !== n && "custom" !== n ? n : null)
        }
        if (!n)
            return null;
        switch (n) {
...
function initializeRecaptchaConfig(e) {
    return async function _initializeRecaptchaConfig(e) {
        ...
        null == t.tenantId ? t._agentRecaptchaConfig = n : t._tenantRecaptchaConfigs[t.tenantId] = n,
        n.isProviderEnabled("EMAIL_PASSWORD_PROVIDER") && new RecaptchaEnterpriseVerifier(t).verify()
    }(e)
}
    ...
    static fromJSON(e) {
        ...
        if (null == e ? void 0 : e.multiFactorSession) {
            if (null === (t = e.multiFactorSession) || void 0 === t ? void 0 : t.pendingCredential)
                return MultiFactorSessionImpl._fromMfaPendingCredential(e.multiFactorSession.pendingCredential);
            if (null === (r = e.multiFactorSession) || void 0 === r ? void 0 : r.idToken)
                return MultiFactorSessionImpl._fromIdtoken(e.multiFactorSession.idToken)
        }
        return null
    }
}
    ...
    static _fromError(e, t) {
        ...
        return new MultiFactorResolverImpl(s,i,(async e=>{
            ...
            case "signIn":
                ...
                return await r._updateCurrentUser(e.user),
                e;
            case "reauthenticate":
                return _assert(t.user, r, "internal-error"),
                UserCredentialImpl._forOperation(t.user, t.operationType, o);
            default:
...
function getMultiFactorResolver(e, t) {
    ...
    const n = getModularInstance(e)
      , i = t;
    return _assert(t.customData.operationType, n, "argument-error"),
    _assert(null === (r = i.customData._serverResponse) || void 0 === r ? void 0 : r.mfaPendingCredential, n, "argument-error"),
    MultiFactorResolverImpl._fromError(n, i)
}
class MultiFactorUserImpl {
    ...
    async enroll(e, t) {
        ...
        return await this.user._updateTokensIfNecessary(i),
        this.user.reload()
    }
    async unenroll(e) {
...
function multiFactor(e) {
    const t = getModularInstance(e);
    return S.has(t) || S.set(t, MultiFactorUserImpl._fromUser(t)),
    S.get(t)
}
class BrowserPersistenceClass {
    ...
    _isAvailable() {
        try {
            return this.storage ? (this.storage.setItem("__sak", "1"),
...
class BrowserLocalPersistence extends BrowserPersistenceClass {
    constructor() {
        ...
        this.localCache = {},
        this.pollTimer = null,
        this.safariLocalStorageNotSynced = function _iframeCannotSyncWebStorage() {
            const e = getUA();
...
const R = BrowserLocalPersistence;
...
class Receiver {
    ...
    async handleEvent(e) {
        ...
        const o = Array.from(s).map((async e=>e(t.origin, i)))
          , a = await function _allSettled(e) {
...
function _openDatabase() {
    ...
    return new Promise(((t,r)=>{
        ...
        e.addEventListener("success", (async()=>{
            const r = e.result;
            r.objectStoreNames.contains("firebaseLocalStorage") ? t(r) : (r.close(),
            await function _deleteDatabase() {
...
class IndexedDBLocalPersistence {
    ...
    async _openDb() {
        return this.db || (this.db = await _openDatabase()),
        this.db
    }
    ...
    async _isAvailable() {
        try {
            ...
            return await _putObject(e, "__sak", "1"),
            await _deleteObject(e, "__sak"),
            !0
        } catch (e) {}
        return !1
    }
    ...
    async _set(e, t) {
        return this._withPendingWrite((async()=>(await this._withRetries((r=>_putObject(r, e, t))),
        this.localCache[e] = t,
    ...
    async _remove(e) {
        return this._withPendingWrite((async()=>(await this._withRetries((t=>_deleteObject(t, e))),
        delete this.localCache[e],
        this.notifyServiceWorker(e))))
    }
    async _poll() {
        ...
        for (const {fbase_key: n, value: i} of e)
            r.add(n),
            JSON.stringify(this.localCache[n]) !== JSON.stringify(i) && (this.notifyListeners(n, i),
            t.push(n));
        for (const e of Object.keys(this.localCache))
            this.localCache[e] && !r.has(e) && (this.notifyListeners(e, null),
            t.push(e));
        return t
    }
    notifyListeners(e, t) {
...
const k = IndexedDBLocalPersistence;
class MockReCaptcha {
    constructor(e) {
        this.auth = e,
        this.counter = 1e12,
    ...
    render(e, t) {
        ...
        return this._widgets.set(r, new MockWidget(e,this.auth.name,t || {})),
        this.counter++,
        r
    }
    reset(e) {
...
const C = _generateCallbackName("rcb")
  , O = new Delay(3e4,6e4);
class ReCaptchaLoaderImpl {
    constructor() {
        ...
        this.hostLanguage = "",
        this.counter = 0,
        this.librarySeparatelyLoaded = !!(null === (e = _window().grecaptcha) || void 0 === e ? void 0 : e.render)
    }
    load(e, t="") {
        return _assert(function isHostLanguageValid(e) {
            return e.length <= 6 && /^\s*[a-zA-Z0-9\-]*\s*$/.test(e)
        }(t), e, "argument-error"),
        this.shouldResolveImmediately(t) && isV2(_window().grecaptcha) ? Promise.resolve(_window().grecaptcha) : new Promise(((r,n)=>{
            ...
            _window()[C] = ()=>{
                ...
                if (!s || !isV2(s))
                    return void n(_createError(e, "internal-error"));
                const o = s.render;
                s.render = (e,t)=>{
                    const r = o(e, t);
                    return this.counter++,
            ...
            ;
            _loadJS(`https://www.google.com/recaptcha/api.js??${querystring({
                onload: C,
                render: "explicit",
                hl: t
            })}`).catch((()=>{
                clearTimeout(i),
                n(_createError(e, "internal-error"))
            }
            ))
        }
        ))
...
class RecaptchaVerifier {
    constructor(e, t, r=Object.assign({}, N)) {
        this.parameters = r,
        this.type = "recaptcha",
        this.destroyed = !1,
        this.widgetId = null,
        ...
        _assert("undefined" != typeof document, this.auth, "operation-not-supported-in-this-environment");
        const n = "string" == typeof t ? document.getElementById(t) : t;
        _assert(n, this.auth, "argument-error"),
        this.container = n,
    ...
    async verify() {
        ...
        return r || new Promise((r=>{
            const tokenChange = e=>{
                e && (this.tokenChangeListeners.delete(tokenChange),
                r(e))
            }
            ;
    ...
    clear() {
        ...
        this.isInvisible || this.container.childNodes.forEach((e=>{
    ...
    makeTokenCallback(e) {
        return t=>{
            if (this.tokenChangeListeners.forEach((e=>e(t))),
            "function" == typeof e)
                e(t);
    ...
    getAssertedRecaptcha() {
        return _assert(this.recaptcha, this.auth, "internal-error"),
        this.recaptcha
    }
}
...
async function _verifyPhoneNumber(e, t, r) {
    ...
    try {
        let s;
        if (_assert("string" == typeof i, e, "argument-error"),
        _assert("recaptcha" === r.type, e, "argument-error"),
        s = "string" == typeof t ? {
            phoneNumber: t
        } : t,
        "session"in s) {
            ...
            if ("phoneNumber"in s) {
                ...
                const r = await function startEnrollPhoneMfa(e, t) {
            ...
            }
            {
                ...
                const o = await function startSignInPhoneMfa(e, t) {
        ...
        {
            const {sessionInfo: t} = await async function sendPhoneVerificationCode(e, t) {
...
function _withDefaultResolver(e, t) {
    return t ? _getInstance(t) : (_assert(e._popupRedirectResolver, e, "argument-error"),
...
function _reauth(e) {
    ...
    return _assert(r, t, "internal-error"),
    _reauthenticate(r, new IdpCredential(e), e.bypassAuthState)
}
async function _link(e) {
    const {auth: t, user: r} = e;
    return _assert(r, t, "internal-error"),
    _link$1(r, new IdpCredential(e), e.bypassAuthState)
}
class AbstractPopupRedirectOperation {
    ...
    async onAuthEvent(e) {
        const {urlResponse: t, sessionId: r, postBody: n, tenantId: i, error: s, type: o} = e;
        if (s)
...
class PopupOperation extends AbstractPopupRedirectOperation {
    ...
    async executeNotNull() {
        ...
        return _assert(e, this.auth, "internal-error"),
        e
    }
    async onExecution() {
...
class RedirectAction extends AbstractPopupRedirectOperation {
    ...
    async execute() {
        ...
        if (!e) {
            ...
            L.set(this.auth._key(), e)
        }
        return this.bypassAuthState || L.set(this.auth._key(), (()=>Promise.resolve(null))),
        e()
    }
    async onAuthEvent(e) {
...
function signInWithRedirect(e, t, r) {
    return async function _signInWithRedirect(e, t, r) {
        ...
        const i = _withDefaultResolver(n, r);
        return await _setPendingRedirectStatus(i, n),
        i._openRedirect(n, t, "signInViaRedirect")
    }(e, t, r)
}
...
function linkWithRedirect(e, t, r) {
    return async function _linkWithRedirect(e, t, r) {
        ...
        await n.auth._initializationPromise;
        const i = _withDefaultResolver(n.auth, r);
        await _assertLinkedStatus(!1, n, t.providerId),
        await _setPendingRedirectStatus(i, n.auth);
        const s = await prepareUserForRedirect(n);
...
async function getRedirectResult(e, t) {
    return await _castAuth(e)._initializationPromise,
...
async function _getRedirectResult(e, t, r=!1) {
    const n = _castAuth(e)
      ...
      , o = await s.execute();
    return o && !r && (delete o.user._redirectEventId,
...
class AuthEventManager {
    ...
    onEvent(e) {
        ...
        return this.consumers.forEach((r=>{
            this.isEventForConsumer(e, r) && (t = !0,
    ...
    hasEventBeenHandled(e) {
        ...
        this.cachedEventUids.has(eventUid(e))
    }
    saveEventToCache(e) {
...
function isNullRedirectEvent({type: e, error: t}) {
...
async function _validateOrigin(e) {
    if (e.config.emulator)
        return;
    const {authorizedDomains: t} = await async function _getProjectConfig(e, t={}) {
...
function _loadGapi(e) {
    return V = V || function loadGapi(e) {
        return new Promise(((t,r)=>{
            var n, i, s;
            ...
            if (null === (i = null === (n = _window().gapi) || void 0 === n ? void 0 : n.iframes) || void 0 === i ? void 0 : i.Iframe)
                t(gapi.iframes.getContext());
            else {
                if (!(null === (s = _window().gapi) || void 0 === s ? void 0 : s.load)) {
                    ...
                    ,
                    _loadJS(`https://apis.google.com/js/api.js?onload=${t}`).catch((e=>r(e)))
                }
                loadGapiIframe()
            }
        }
...
const W = new Delay(5e3,15e3)
  ...
  , H = new Map([["identitytoolkit.googleapis.com", "p"], ["staging-identitytoolkit.sandbox.googleapis.com", "s"], ["test-identitytoolkit.sandbox.googleapis.com", "t"]]);
function getIframeUrl(e) {
    ...
    const r = t.emulator ? _emulatorUrl(t, "emulator/auth/iframe") : `https://${e.config.authDomain}/__/auth/iframe`
      ...
      , s = H.get(e.config.apiHost);
    s && (i.eid = s);
    const o = e._getFrameworks();
    return o.length && (i.fw = o.join(",")),
    `${r}?${querystring(i).slice(1)}`
}
const q = {
    location: "yes",
    resizable: "yes",
...
function _open(e, t, r, n=500, i=600) {
    ...
    let a = "";
    const c = Object.assign(Object.assign({}, q), {
        width: n.toString(),
        height: i.toString(),
        top: s,
        left: o
      ...
      , d = getUA().toLowerCase();
    r && (a = _isChromeIOS(d) ? "_blank" : r),
    _isFirefox(d) && (t = t || "http://localhost",
    c.scrollbars = "yes");
    ...
    if (function _isIOSStandalone(e=getUA()) {
        ...
        return function openAsNewWindowIOS(e, t) {
            const r = document.createElement("a");
            r.href = e,
            r.target = t;
            const n = document.createEvent("MouseEvent");
            n.initMouseEvent("click", !0, !0, window, 1, 0, 0, 0, 0, !1, !1, !1, !1, 1, null),
            r.dispatchEvent(n)
        }(t || "", a),
        new AuthPopup(null);
...
const j = encodeURIComponent("fac");
async function _getRedirectUrl(e, t, r, i, s, o) {
    ...
    const d = await e._getAppCheckToken()
      , u = d ? `#${j}=${encodeURIComponent(d)}` : "";
    return `${function getHandlerBase({config: e}) {
        if (!e.emulator)
            return `https://${e.authDomain}/__/auth/handler`;
        return _emulatorUrl(e, "emulator/auth/handler")
    }(e)}?${querystring(c).slice(1)}${u}`
}
const G = class BrowserPopupRedirectResolver {
    constructor() {
        this.eventManagers = {},
        this.iframes = {},
        this.originValidationPromises = {},
        this._redirectPersistence = P,
        this._completeRedirectFn = _getRedirectResult,
        this._overrideRedirectResult = _overrideRedirectResult
    }
    async _openPopup(e, t, r, n) {
        var i;
        debugAssert(null === (i = this.eventManagers[e._key()]) || void 0 === i ? void 0 : i.manager, "_initialize() not called before _openPopup()");
        return _open(e, await _getRedirectUrl(e, t, r, _getCurrentUrl(), n), _generateEventId())
    }
    async _openRedirect(e, t, r, n) {
        await this._originValidation(e);
        return function _setWindowLocation(e) {
            _window().location.href = e
    ...
    _initialize(e) {
        ...
        if (this.eventManagers[t]) {
            ...
            return e ? Promise.resolve(e) : (debugAssert(r, "If manager is not set, promise should be"),
            r)
        }
    ...
    async initAndGetManager(e) {
        const t = await async function _openIframe(e) {
            const t = await _loadGapi(e)
              , r = _window().gapi;
            return _assert(r, e, "internal-error"),
            t.open({
                where: document.body,
                url: getIframeUrl(e),
    ...
    _isIframeWebStorageSupported(e, t) {
        this.iframes[e._key()].send("webStorageSupport", {
            ...
            var n;
            const i = null === (n = null == r ? void 0 : r[0]) || void 0 === n ? void 0 : n.webStorageSupport;
            void 0 !== i && t(!!i),
            _fail(e, "internal-error")
        }
        ), gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)
    ...
    _originValidation(e) {
        const t = e._key();
        return this.originValidationPromises[t] || (this.originValidationPromises[t] = _validateOrigin(e)),
...
class PhoneMultiFactorAssertionImpl extends MultiFactorAssertionImpl {
    ...
    _finalizeEnroll(e, t, r) {
        return function finalizeEnrollPhoneMfa(e, t) {
            return _performApiRequest(e, "POST", "/v2/accounts/mfaEnrollment:finalize", _addTidIfNecessary(e, t))
        }(e, {
            idToken: t,
            displayName: r,
    ...
    _finalizeSignIn(e, t) {
        return function finalizeSignInPhoneMfa(e, t) {
            return _performApiRequest(e, "POST", "/v2/accounts/mfaSignIn:finalize", _addTidIfNecessary(e, t))
        }(e, {
...
class TotpMultiFactorGenerator {
    ...
    static async generateSecret(e) {
        var t;
        const r = e;
        _assert(void 0 !== (null === (t = r.user) || void 0 === t ? void 0 : t.auth), "internal-error");
        const n = await function startEnrollTotpMfa(e, t) {
            return _performApiRequest(e, "POST", "/v2/accounts/mfaEnrollment:start", _addTidIfNecessary(e, t))
        }(r.user.auth, {
            idToken: r.credential,
            totpEnrollmentInfo: {}
        });
        return TotpSecret._fromStartTotpMfaEnrollmentResponse(n, r.user.auth)
    }
}
...
class TotpMultiFactorAssertionImpl extends MultiFactorAssertionImpl {
    ...
    async _finalizeEnroll(e, t, r) {
        return _assert(void 0 !== this.secret, e, "argument-error"),
        function finalizeEnrollTotpMfa(e, t) {
            return _performApiRequest(e, "POST", "/v2/accounts/mfaEnrollment:finalize", _addTidIfNecessary(e, t))
        }(e, {
            idToken: t,
            displayName: r,
    ...
    async _finalizeSignIn(e, t) {
        ...
        return function finalizeSignInTotpMfa(e, t) {
            return _performApiRequest(e, "POST", "/v2/accounts/mfaSignIn:finalize", _addTidIfNecessary(e, t))
        }(e, {
            mfaPendingCredential: t,
...
class TotpSecret {
    ...
    generateQrCodeUrl(e, t) {
        var r;
        let n = !1;
        return (_isEmptyString(e) || _isEmptyString(t)) && (n = !0),
        n && (_isEmptyString(e) && (e = (null === (r = this.auth.currentUser) || void 0 === r ? void 0 : r.email) || "unknownuser"),
...
const z = getExperimentalSetting("authIdTokenMaxAge") || 300;
let K = null;
function getAuth(e=r()) {
    const t = _getProvider(e, "auth");
    if (t.isInitialized())
        return t.getImmediate();
    const n = initializeAuth(e, {
        popupRedirectResolver: G,
        persistence: [k, R, P]
    })
      , i = getExperimentalSetting("authTokenSyncURL");
    if (i) {
        const e = (s = i,
        async e=>{
        ...
        beforeAuthStateChanged(n, e, (()=>e(n.currentUser))),
        onIdTokenChanged(n, (t=>e(t)))
    }
    var s;
    const o = (a = "auth",
    null === (d = null === (c = getDefaults()) || void 0 === c ? void 0 : c.emulatorHosts) || void 0 === d ? void 0 : d[a]);
    var a, c, d;
    return o && connectAuthEmulator(n, `http://${o}`),
    n
}
!function registerAuth(r) {
    e(new Component("auth",((e,{options: t})=>{
        const n = e.getProvider("app").getImmediate()
          , i = e.getProvider("heartbeat")
          , s = e.getProvider("app-check-internal")
          , {apiKey: o, authDomain: a} = n.options;
        _assert(o && !o.includes(":"), "invalid-api-key", {
            appName: n.name
        });
        const c = {
            apiKey: o,
          ...
          , d = new AuthImpl(n,i,s,c);
        return function _initializeAuthInstance(e, t) {
            const r = (null == t ? void 0 : t.persistence) || []
              , n = (Array.isArray(r) ? r : [r]).map(_getInstance);
            (null == t ? void 0 : t.errorMap) && e._updateErrorMap(t.errorMap),
            e._initializeWithPersistence(n, null == t ? void 0 : t.popupRedirectResolver)
        }(d, t),
        d
    }
    ...
    e(new Component("auth-internal",(e=>(e=>new AuthInterop(e))(_castAuth(e.getProvider("auth").getImmediate()))),"PRIVATE").setInstantiationMode("EXPLICIT")),
    t(B, "1.3.1", function getVersionForPlatform(e) {
        switch (e) {
        case "Node":
            return "node";
        case "ReactNative":
